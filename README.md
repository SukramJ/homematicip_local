...
- [Step 1: CCU Connection Settings](#step-1-ccu-connection-settings)
  ...
  - [Advanced Connection Settings (Optional)](#advanced-connection-settings-optional)
    - [Docker Users: Network Setup](#docker-users-network-setup)
- [Step 2: Interface Selection](#step-2-interface-selection)
  - [Common Interface Configurations](#common-interface-configurations)
    - [HomematicIP Only (Most Modern Setups)](#homematicip-only-most-modern-setups)
    - [Mixed Homematic & HomematicIP](#mixed-homematic--homematicip)
...
- [Two Modes: DEFAULT vs EXTENDED](#two-modes-default-vs-extended)
  - [DEFAULT Mode (Read-Only)](#default-mode-read-only)
  - [EXTENDED Mode (Writable) ⭐ Recommended](#extended-mode-writable--recommended)
- [Filtering: Import Only What You Need](#filtering-import-only-what-you-need)
  ...
  - [Example: Smart Filtering Setup](#example-smart-filtering-setup)
- [CCU Programs](#ccu-programs)
- [Quick Start Guide](#quick-start-guide)
  - [For Beginners (Simple Setup)](#for-beginners-simple-setup)
  - [For Power Users (Filtered + Writable)](#for-power-users-filtered--writable)
- [Important Notes](#important-notes)
- [Actions](#actions)
  - [`homematicip_local.add_link`](#homematicip_localadd_link)
  - [`homematicip_local.clear_cache`](#homematicip_localclear_cache)
  - [`homematicip_local.create_central_links`](#homematicip_localcreate_central_links)
  - [`homematicip_local.copy_schedule`](#homematicip_localcopy_schedule)
  - [`homematicip_local.copy_schedule_profile`](#homematicip_localcopy_schedule_profile)
  - [`homematicip_local.disable_away_mode`](#homematicip_localdisable_away_mode)
  - [`homematicip_local.enable_away_mode_by_calendar`](#homematicip_localenable_away_mode_by_calendar)
  - [`homematicip_local.enable_away_mode_by_duration`](#homematicip_localenable_away_mode_by_duration)
  - [`homematicip_local.export_device_definition`](#homematicip_localexport_device_definition)
  - [`homematicip_local.fetch_system_variables`](#homematicip_localfetch_system_variables)
  - [`homematicip_local.force_device_availability`](#homematicip_localforce_device_availability)
  - [`homematicip_local.get_device_value`](#homematicip_localget_device_value)
  - [`homematicip_local.get_link_peers`](#homematicip_localget_link_peers)
  - [`homematicip_local.get_paramset`](#homematicip_localget_paramset)
  - [`homematicip_local.get_link_paramset`](#homematicip_localget_link_paramset)
  - [`homematicip_local.get_schedule_profile`](#homematicip_localget_schedule_profile)
  - [`homematicip_local.get_schedule_weekday`](#homematicip_localget_schedule_weekday)
  - [`homematicip_local.put_paramset`](#homematicip_localput_paramset)
  - [`homematicip_local.put_link_paramset`](#homematicip_localput_link_paramset)
  - [`homematicip_local.record_session`](#homematicip_localrecord_session)
  - [`homematicip_local.remove_central_links`](#homematicip_localremove_central_links)
  - [`homematicip_local.remove_link`](#homematicip_localremove_link)
  - [`homematicip_local.set_cover_combined_position`](#homematicip_localset_cover_combined_position)
  - [`homematicip_local.set_device_value`](#homematicip_localset_device_value)
  - [`homematicip_local.set_schedule_profile`](#homematicip_localset_schedule_profile)
  - [`homematicip_local.set_schedule_weekday`](#homematicip_localset_schedule_weekday)
  - [`homematicip_local.set_schedule_simple_profile`](#homematicip_localset_schedule_simple_profile)
  - [`homematicip_local.set_schedule_simple_weekday`](#homematicip_localset_schedule_simple_weekday)
  - [`homematicip_local.get_variable_value`](#homematicip_localget_variable_value)
  - [`homematicip_local.set_variable_value`](#homematicip_localset_variable_value)
  - [`homematicip_local.turn_on_siren`](#homematicip_localturn_on_siren)
  - [`homematicip_local.light_set_on_time`](#homematicip_locallight_set_on_time)
  - [`homematicip_local.switch_set_on_time`](#homematicip_localswitch_set_on_time)
  - [`homeassistant.update_entity`](#homeassistantupdate_entity)
  - [`homeassistant.update_device_firmware_data`](#homeassistantupdate_device_firmware_data)
- [Events](#events)
  - [`homematic.keypress`](#homematickeypress)
  - [`homematic.device_availability`](#homematicdevice_availability)
  - [`homematic.device_error`](#homematicdevice_error)
- [Additional Information](#additional-information)
- [Understanding Entity States & Updates](#understanding-entity-states--updates)
  - [How State Updates Work](#how-state-updates-work)
  - [The `value_state` Attribute](#the-value_state-attribute)
  - [Optimized Backend Calls](#optimized-backend-calls)
- [Managing Devices & Entities](#managing-devices--entities)
  - [Removing Devices](#removing-devices)
  - [Renaming Devices After CCU Changes](#renaming-devices-after-ccu-changes)
  - [CCU Rooms → HA Areas](#ccu-rooms-%E2%86%92-ha-areas)
- [Working with Device Parameters](#working-with-device-parameters)
  - [Deactivated vs Disabled Entities](#deactivated-vs-disabled-entities)
  - [Unignoring Parameters](#unignoring-parameters)
  - [Special Case: HmIP-eTRV LEVEL Parameter](#special-case-hmip-etrv-level-parameter)
- [Button Devices & Events](#button-devices--events)
  - [Why Buttons Don't Show Entities](#why-buttons-dont-show-entities)
  - [Using Buttons in Automations](#using-buttons-in-automations)
  - [Enabling Button Events](#enabling-button-events)
  - [Triggering CCU Buttons from HA](#triggering-ccu-buttons-from-ha)
- [Troubleshooting Common Issues](#troubleshooting-common-issues)
  - ["Error fetching initial data"](#error-fetching-initial-data)
  - ["XmlRPC-Server received no events"](#xmlrpc-server-received-no-events)
  - ["Pending Pong mismatch"](#pending-pong-mismatch)
- [Technical Details](#technical-details)
  - [RSSI Signal Strength](#rssi-signal-strength)
- [Updating Device Firmware](#updating-device-firmware)
  - [How Firmware Updates Work](#how-firmware-updates-work)
  - [Update Check Schedule](#update-check-schedule)
  - [Using Firmware Updates in HA](#using-firmware-updates-in-ha)
  - [Update Latency](#update-latency)
  - [On-Demand Update Check](#on-demand-update-check)
- [CUxD, CCU-Jack & MQTT Support](#cuxd-ccu-jack--mqtt-support)
  - [Communication Methods](#communication-methods)
- [Setting Up MQTT Support](#setting-up-mqtt-support)
  - [Prerequisites](#prerequisites)
  - [Setup Option 1: Direct Connection (Recommended)](#setup-option-1-direct-connection-recommended)
  - [Setup Option 2: MQTT Bridge](#setup-option-2-mqtt-bridge)
  - [Enabling System Variable MQTT Updates](#enabling-system-variable-mqtt-updates)
...
- [Examples in YAML](#examples-in-yaml)
  - [Sample for set_variable_value](#sample-for-set_variable_value)
  - [Sample for set_device_value](#sample-for-set_device_value)
  - [Sample 2 for set_device_value](#sample-2-for-set_device_value)
  - [Sample for set_schedule_weekday](#sample-for-set_schedule_weekday)
  - [Sample for set_schedule_simple_profile](#sample-for-set_schedule_simple_profile)
  - [Sample for set_schedule_simple_weekday](#sample-for-set_schedule_simple_weekday)
  - [Sample for put_paramset](#sample-for-put_paramset)
  - [Sample 2 for put_paramset](#sample-2-for-put_paramset)
