...
`,me=new Set(["BidCos-RF","BidCos-Wired","HmIP-RF"]);function ge(e,t){return`/api/homematicip_local/${e}/device_icon/${t}`}async function fe(e,t){return(await e.callWS({type:"homematicip_local/config/list_devices",entry_id:t})).devices}async function ye(e,t,i,s,a="",n="MASTER"){return e.callWS({type:"homematicip_local/config/get_form_schema",entry_id:t,interface_id:i,channel_address:s,channel_type:a,paramset_key:n})}async function be(e,t,i,s,a="MASTER"){return e.callWS({type:"homematicip_local/config/session_open",entry_id:t,interface_id:i,channel_address:s,paramset_key:a})}async function xe(e,t,i,s="MASTER"){return e.callWS({type:"homematicip_local/config/session_discard",entry_id:t,channel_address:i,paramset_key:s})}async function $e(e,t,i,s,a){return e.callWS({type:"homematicip_local/config/get_link_form_schema",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a})}async function ke(e,t,i,s,a,n){return e.callWS({type:"homematicip_local/config/put_link_paramset",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a,values:n})}async function we(e,t){return(await e.callWS({type:"homematicip_local/config/list_schedule_devices",entry_id:t})).devices}async function Se(e,t,i,s){return e.callWS({type:"homematicip_local/config/get_climate_schedule",entry_id:t,device_address:i,...s&&{profile:s}})}async function Ce(e,t,i,s,a,n,r){return e.callWS({type:"homematicip_local/config/set_climate_schedule_weekday",entry_id:t,device_address:i,profile:s,weekday:a,base_temperature:n,simple_weekday_list:r})}async function Ee(e,t,i,s){return e.callWS({type:"homematicip_local/config/set_device_schedule",entry_id:t,device_address:i,schedule_data:s})}async function Ae(e,t,i,s,a){try{return await e.callWS({type:"homematicip_local/config/get_link_profiles",entry_id:t,interface_id:i,sender_channel_address:s,receiver_channel_address:a})}catch{return null}}const Ie={en:{common:{back:"Back",loading:"Loading...",save:"Save",cancel:"Cancel",yes:"Yes",no:"No"},device_list:{title:"Homematic Device Configuration",select_ccu:"CCU",select_placeholder:"Select a CCU...",search_placeholder:"Search devices...",no_entry_selected:"Please select a CCU to view devices.",no_devices:"No configurable devices found.",channels:"channels",unreachable:"Unreachable",reachable:"Reachable",low_battery:"Low battery",config_pending:"Configuration pending"},device_detail:{address:"Address",firmware:"Firmware",channel:"Channel",configure_master:"Configure MASTER",no_master_config:"No MASTER configuration available.",not_found:"Device not found.",yes:"Yes",no:"No",reachable:"Reachable",unreachable:"Unreachable",export:"Export",import:"Import",export_success:"Configuration exported successfully.",export_failed:"Failed to export configuration.",import_confirm_title:"Import Configuration",import_confirm_text:"Import and apply configuration to channel {channel}?",import_success:"Configuration imported successfully.",import_failed:"Failed to import configuration.",import_validation_failed:"Import validation failed.",show_history:"Change History",show_links:"Direct Links",show_schedules:"Schedules",rssi_device:"RSSI Device",rssi_peer:"RSSI Peer",dutycycle:"DC Limit",low_bat:"Low Battery",unreach:"Reachability",config_pending_label:"Config Pending",device_config:"Device Configuration"},form_parameter:{toggle_on:"On",toggle_off:"Off",custom_value:"Custom value"},time_selector:{base:"Base",factor:"Factor"},channel_config:{save:"Save",saving:"Saving...",discard:"Discard Changes",reset_defaults:"Reset to Defaults",confirm_save_title:"Save Changes",confirm_save_text:"Apply {count} change(s) to the device?",unsaved_title:"Unsaved Changes",unsaved_warning:"You have unsaved changes. Discard them and go back?",save_success:"Changes saved successfully.",save_failed:"Failed to save changes.",validation_failed:"Validation failed. Please check the highlighted fields.",undo:"Undo",redo:"Redo"},change_history:{title:"Change History",empty:"No configuration changes recorded.",clear:"Clear History",clear_confirm_title:"Clear History",clear_confirm_text:"Delete all history entries? This cannot be undone.",clear_success:"History cleared ({count} entries removed).",source_manual:"Manual",source_import:"Import",source_copy:"Copy",parameters_changed:"{count} parameter(s) changed"},device_links:{title:"Direct Links",subtitle:"Direct links for {device}",empty:"No direct links configured.",add_link:"New Link",outgoing:"Outgoing",incoming:"Incoming",configure:"Configure",delete:"Delete",delete_confirm_title:"Delete Link",delete_confirm_text:"Remove the direct link from {sender} to {receiver}? The devices will no longer communicate directly.",delete_success:"Link deleted successfully.",delete_failed:"Failed to delete link.",channel_group:"Channel {channel}"},link_config:{title:"Link Configuration",sender:"Sender",receiver:"Receiver",save_success:"Link configuration saved.",save_failed:"Failed to save link configuration.",discard:"Discard Changes",confirm_save_title:"Save Link Changes",confirm_save_text:"Apply {count} change(s) to this link?",unsaved_title:"Unsaved Changes",unsaved_warning:"You have unsaved changes. Discard them and go back?",receiver_params:"Receiver Parameters",sender_params:"Sender Parameters",no_params:"No configurable parameters for this link.",profile:"Profile",short_keypress:"Short keypress",long_keypress:"Long keypress",last_value:"Last value",custom_time:"Custom"},device_schedule:{title:"Schedules",subtitle:"Schedules for {device}",select_device:"Select a device...",no_devices:"No devices with schedule support found.",schedule_type_climate:"Climate",schedule_type_default:"Device",profile:"Profile",active_profile:"Active profile",weekdays:"Mon,Tue,Wed,Thu,Fri,Sat,Sun",weekday_monday:"Monday",weekday_tuesday:"Tuesday",weekday_wednesday:"Wednesday",weekday_thursday:"Thursday",weekday_friday:"Friday",weekday_saturday:"Saturday",weekday_sunday:"Sunday",base_temperature:"Base temperature",temperature:"Temperature",time:"Time",from:"From",to:"To",add_period:"Add period",delete_period:"Delete",save:"Save",saving:"Saving...",save_success:"Schedule saved successfully.",save_failed:"Failed to save schedule.",load_failed:"Failed to load schedule.",reload:"Reload from device",reload_success:"Device configuration reloaded.",reload_failed:"Failed to reload device configuration.",export:"Export",import:"Import",import_confirm_title:"Import Schedule",import_confirm_text:"Import and apply this schedule?",import_success:"Schedule imported.",import_failed:"Failed to import schedule.",no_schedule_data:"No schedule data available.",click_to_edit:"Click on a time slot to edit the schedule",copy_schedule:"Copy schedule",paste_schedule:"Paste schedule",edit:"Edit {weekday}",add_time_block:"+ Add Time Block",edit_slot:"Edit",save_slot:"Save",cancel_slot_edit:"Cancel",undo_shortcut:"Undo (Ctrl+Z)",redo_shortcut:"Redo (Ctrl+Y)",warnings_title:"Validation Warnings",base_temperature_description:"Temperature for unscheduled periods",temperature_periods:"Temperature Periods",invalid_schedule:"Invalid schedule: {error}",validation_block_end_before_start:"Block {block}: End time is before start time",validation_block_zero_duration:"Block {block}: Block has zero duration",validation_invalid_start_time:"Block {block}: Invalid start time",validation_invalid_end_time:"Block {block}: Invalid end time",validation_temp_out_of_range:"Block {block}: Temperature out of range ({min}-{max}°C)",validation_invalid_slot_count:"Invalid number of slots: {count} (expected 13)",validation_invalid_slot_key:"Invalid slot key: {key} (must be integer 1-13)",validation_missing_slot:"Missing slot {slot}",validation_slot_missing_values:"Slot {slot} missing ENDTIME or TEMPERATURE",validation_slot_time_backwards:"Slot {slot} time goes backwards: {time}",validation_slot_time_exceeds_day:"Slot {slot} time exceeds 24:00: {time}",validation_last_slot_must_end:"Last slot must end at 24:00",validation_schedule_must_be_object:"Schedule data must be an object",validation_missing_weekday:"Missing weekday: {weekday}",validation_invalid_weekday_data:"Invalid data for {weekday}",validation_weekday_error:"{weekday}: {details}",entries:"{count} entries",max_entries:"Max entries: {max}",level:"Level",duration:"Duration",condition:"Condition",target_channel:"Target channel",add_event:"Add Event",edit_event:"Edit Event",confirm_delete:"Are you sure you want to delete this event?",weekdays_label:"Weekdays",level_on:"On",level_off:"Off",slat:"Slat Position",ramp_time:"Ramp Time",astro_sunrise:"Sunrise",astro_sunset:"Sunset",astro_offset:"Astro Offset (min)",condition_fixed_time:"Fixed Time",condition_astro:"Astro",condition_fixed_if_before_astro:"Fixed if before Astro",condition_astro_if_before_fixed:"Astro if before Fixed",condition_fixed_if_after_astro:"Fixed if after Astro",condition_astro_if_after_fixed:"Astro if after Fixed",condition_earliest:"Earliest",condition_latest:"Latest"},add_link:{title:"New Direct Link",step_channel:"Step 1/3 — Select Channel",step_peer:"Step 2/3 — Select Partner",step_confirm:"Step 3/3 — Confirm",select_channel:"Select a channel from this device:",select_role:"Role of selected channel:",role_sender:"Sender (sends commands)",role_receiver:"Receiver (receives commands)",search_devices:"Search devices...",no_compatible:"No compatible channels found.",link_name:"Link name (optional)",create:"Create Link",create_success:"Link created successfully.",create_failed:"Failed to create link.",next:"Next",back:"Back"},tabs:{devices:"Devices",integration:"Integration",ccu:"OpenCCU"},integration:{system_health:"System Health",central_state:"Central State",health_score:"Health Score",device_statistics:"Device Statistics",total_devices:"Total Devices",unreachable:"Unreachable",firmware_updatable:"Firmware Updatable",total_short:"total",unreachable_short:"unreachable",command_throttle:"Command Throttle",enabled:"Enabled",interval:"Interval",queue_size:"Queue Size",throttled:"Throttled",burst_count:"Burst Count",incidents:"Incidents",no_incidents:"No incidents recorded.",clear_incidents:"Clear Incidents",clear_incidents_title:"Clear Incidents",clear_incidents_text:"Delete all recorded incidents? This cannot be undone.",incidents_cleared:"Incidents cleared.",clear:"Clear",clear_cache:"Clear Cache",clear_cache_title:"Clear Cache",clear_cache_text:"Clear all cached data? The integration will re-fetch data from the CCU.",cache_cleared:"Cache cleared.",actions:"Actions",refresh:"Refresh",action_failed:"Action failed."},ccu:{system_information:"System Information",name:"Name",model:"Model",version:"Version",serial:"Serial",hostname:"Hostname",ccu_type:"CCU Type",interfaces:"Interfaces",auth_enabled:"Authentication",update_available:"Update available",backup_exists:"Backup available",hub_messages:"Hub Messages",service_messages:"Service Messages",alarm_messages:"Alarm Messages",install_mode:"Install Mode",active:"Active",inactive:"Inactive",remaining_seconds:"{seconds}s remaining",activate:"Activate",install_mode_title:"Activate Install Mode",install_mode_text:"Activate install mode for {interface}? The CCU will accept new devices for 60 seconds.",install_mode_activated:"Install mode activated for {interface}.",signal_quality:"Signal Quality",device:"Device",interface:"Interface",reachable:"Reachable",signal:"Signal",battery:"Battery",low:"Low",ok:"OK",firmware_overview:"Firmware Overview",updatable:"updatable",current_fw:"Current",available_fw:"Available",state:"State",refresh_firmware:"Refresh Firmware Data",firmware_refreshed:"Firmware data refreshed.",actions:"Actions",refresh:"Refresh",create_backup:"Create Backup",create_backup_title:"Create CCU Backup",create_backup_text:"Create a backup of the CCU configuration? This may take a moment.",backup_running:"Creating backup...",backup_success:"Backup created: {filename} ({size} MB)",backup_failed:"Failed to create backup.",action_failed:"Action failed.",filter_devices:"Filter devices...",filter_all:"All",filter_result:"{count} of {total} devices"},cross_validation:{max_must_be_gte_min:"Maximum must be greater than or equal to minimum.",level_must_be_in_range:"Level must be between minimum and maximum.",hi_must_be_gte_lo:"Upper threshold must be greater than or equal to lower threshold."}},de:{common:{back:"Zurück",loading:"Laden...",save:"Speichern",cancel:"Abbrechen",yes:"Ja",no:"Nein"},device_list:{title:"Homematic Gerätekonfiguration",select_ccu:"CCU",select_placeholder:"CCU auswählen...",search_placeholder:"Geräte suchen...",no_entry_selected:"Bitte eine CCU auswählen, um Geräte anzuzeigen.",no_devices:"Keine konfigurierbaren Geräte gefunden.",channels:"Kanäle",unreachable:"Nicht erreichbar",reachable:"Erreichbar",low_battery:"Batterie schwach",config_pending:"Konfiguration ausstehend"},device_detail:{address:"Adresse",firmware:"Firmware",channel:"Kanal",configure_master:"MASTER konfigurieren",no_master_config:"Keine MASTER-Konfiguration verfügbar.",not_found:"Gerät nicht gefunden.",yes:"Ja",no:"Nein",reachable:"Erreichbar",unreachable:"Nicht erreichbar",export:"Exportieren",import:"Importieren",export_success:"Konfiguration erfolgreich exportiert.",export_failed:"Export der Konfiguration fehlgeschlagen.",import_confirm_title:"Konfiguration importieren",import_confirm_text:"Konfiguration importieren und auf Kanal {channel} anwenden?",import_success:"Konfiguration erfolgreich importiert.",import_failed:"Import der Konfiguration fehlgeschlagen.",import_validation_failed:"Import-Validierung fehlgeschlagen.",show_history:"Änderungsverlauf",show_links:"Direktverknüpfungen",show_schedules:"Zeitpläne",rssi_device:"RSSI Gerät",rssi_peer:"RSSI Peer",dutycycle:"DC-Limit",low_bat:"Batterie schwach",unreach:"Erreichbarkeit",config_pending_label:"Konfig. ausstehend",device_config:"Gerätekonfiguration"},form_parameter:{toggle_on:"Ein",toggle_off:"Aus",custom_value:"Wert eingeben"},time_selector:{base:"Basis",factor:"Faktor"},channel_config:{save:"Speichern",saving:"Speichern...",discard:"Änderungen verwerfen",reset_defaults:"Standardwerte laden",confirm_save_title:"Änderungen speichern",confirm_save_text:"{count} Änderung(en) auf das Gerät anwenden?",unsaved_title:"Ungespeicherte Änderungen",unsaved_warning:"Es gibt ungespeicherte Änderungen. Verwerfen und zurückgehen?",save_success:"Änderungen erfolgreich gespeichert.",save_failed:"Fehler beim Speichern der Änderungen.",validation_failed:"Validierung fehlgeschlagen. Bitte die markierten Felder prüfen.",undo:"Rückgängig",redo:"Wiederherstellen"},change_history:{title:"Änderungsverlauf",empty:"Keine Konfigurationsänderungen aufgezeichnet.",clear:"Verlauf löschen",clear_confirm_title:"Verlauf löschen",clear_confirm_text:"Alle Verlaufseinträge löschen? Dies kann nicht rückgängig gemacht werden.",clear_success:"Verlauf gelöscht ({count} Einträge entfernt).",source_manual:"Manuell",source_import:"Import",source_copy:"Kopie",parameters_changed:"{count} Parameter geändert"},device_links:{title:"Direktverknüpfungen",subtitle:"Direktverknüpfungen für {device}",empty:"Keine Direktverknüpfungen konfiguriert.",add_link:"Neue Verknüpfung",outgoing:"Ausgehend",incoming:"Eingehend",configure:"Konfigurieren",delete:"Löschen",delete_confirm_title:"Verknüpfung löschen",delete_confirm_text:"Direktverknüpfung von {sender} nach {receiver} entfernen? Die Geräte kommunizieren dann nicht mehr direkt.",delete_success:"Verknüpfung erfolgreich gelöscht.",delete_failed:"Fehler beim Löschen der Verknüpfung.",channel_group:"Kanal {channel}"},link_config:{title:"Link-Konfiguration",sender:"Sender",receiver:"Empfänger",save_success:"Link-Konfiguration gespeichert.",save_failed:"Fehler beim Speichern der Link-Konfiguration.",discard:"Änderungen verwerfen",confirm_save_title:"Link-Änderungen speichern",confirm_save_text:"{count} Änderung(en) auf diese Verknüpfung anwenden?",unsaved_title:"Ungespeicherte Änderungen",unsaved_warning:"Es gibt ungespeicherte Änderungen. Verwerfen und zurückgehen?",receiver_params:"Empfänger-Parameter",sender_params:"Sender-Parameter",no_params:"Keine konfigurierbaren Parameter für diese Verknüpfung.",profile:"Profil",short_keypress:"Kurzer Tastendruck",long_keypress:"Langer Tastendruck",last_value:"Letzter Wert",custom_time:"Benutzerdefiniert"},device_schedule:{title:"Zeitpläne",subtitle:"Zeitpläne für {device}",select_device:"Gerät auswählen...",no_devices:"Keine Geräte mit Zeitplan-Unterstützung gefunden.",schedule_type_climate:"Heizung",schedule_type_default:"Gerät",profile:"Profil",active_profile:"Aktives Profil",weekdays:"Mo,Di,Mi,Do,Fr,Sa,So",weekday_monday:"Montag",weekday_tuesday:"Dienstag",weekday_wednesday:"Mittwoch",weekday_thursday:"Donnerstag",weekday_friday:"Freitag",weekday_saturday:"Samstag",weekday_sunday:"Sonntag",base_temperature:"Basistemperatur",temperature:"Temperatur",time:"Uhrzeit",from:"Von",to:"Bis",add_period:"Zeitraum hinzufügen",delete_period:"Löschen",save:"Speichern",saving:"Speichern...",save_success:"Zeitplan erfolgreich gespeichert.",save_failed:"Fehler beim Speichern des Zeitplans.",load_failed:"Fehler beim Laden des Zeitplans.",reload:"Vom Gerät laden",reload_success:"Gerätekonfiguration neu geladen.",reload_failed:"Fehler beim Laden der Gerätekonfiguration.",export:"Exportieren",import:"Importieren",import_confirm_title:"Zeitplan importieren",import_confirm_text:"Diesen Zeitplan importieren und anwenden?",import_success:"Zeitplan importiert.",import_failed:"Fehler beim Importieren des Zeitplans.",no_schedule_data:"Keine Zeitplan-Daten verfügbar.",click_to_edit:"Klicken Sie auf einen Zeitabschnitt, um den Zeitplan zu bearbeiten",copy_schedule:"Zeitplan kopieren",paste_schedule:"Zeitplan einfügen",edit:"{weekday} bearbeiten",add_time_block:"+ Zeitblock hinzufügen",edit_slot:"Bearbeiten",save_slot:"Speichern",cancel_slot_edit:"Abbrechen",undo_shortcut:"Rückgängig (Strg+Z)",redo_shortcut:"Wiederholen (Strg+Y)",warnings_title:"Validierungswarnungen",base_temperature_description:"Temperatur für nicht geplante Zeiträume",temperature_periods:"Temperaturperioden",invalid_schedule:"Ungültiger Zeitplan: {error}",validation_block_end_before_start:"Block {block}: Die Endzeit liegt vor der Startzeit",validation_block_zero_duration:"Block {block}: Der Block hat keine Dauer",validation_invalid_start_time:"Block {block}: Ungültige Startzeit",validation_invalid_end_time:"Block {block}: Ungültige Endzeit",validation_temp_out_of_range:"Block {block}: Temperatur außerhalb des Bereichs ({min}-{max}°C)",validation_invalid_slot_count:"Ungültige Anzahl an Slots: {count} (erwartet 13)",validation_invalid_slot_key:"Ungültiger Slot-Schlüssel: {key} (muss eine Ganzzahl 1-13 sein)",validation_missing_slot:"Slot {slot} fehlt",validation_slot_missing_values:"Slot {slot} fehlt ENDTIME oder TEMPERATURE",validation_slot_time_backwards:"Slot {slot}: Zeit läuft rückwärts: {time}",validation_slot_time_exceeds_day:"Slot {slot}: Zeit überschreitet 24:00: {time}",validation_last_slot_must_end:"Der letzte Slot muss um 24:00 enden",validation_schedule_must_be_object:"Zeitplandaten müssen ein Objekt sein",validation_missing_weekday:"Fehlender Wochentag: {weekday}",validation_invalid_weekday_data:"Ungültige Daten für {weekday}",validation_weekday_error:"{weekday}: {details}",entries:"{count} Einträge",max_entries:"Max. Einträge: {max}",level:"Wert",duration:"Dauer",condition:"Bedingung",target_channel:"Zielkanal",add_event:"Ereignis hinzufügen",edit_event:"Ereignis bearbeiten",confirm_delete:"Möchten Sie dieses Ereignis wirklich löschen?",weekdays_label:"Wochentage",level_on:"Ein",level_off:"Aus",slat:"Lamellenposition",ramp_time:"Rampenzeit",astro_sunrise:"Sonnenaufgang",astro_sunset:"Sonnenuntergang",astro_offset:"Astro-Offset (Min.)",condition_fixed_time:"Feste Zeit",condition_astro:"Astro",condition_fixed_if_before_astro:"Fest wenn vor Astro",condition_astro_if_before_fixed:"Astro wenn vor Fest",condition_fixed_if_after_astro:"Fest wenn nach Astro",condition_astro_if_after_fixed:"Astro wenn nach Fest",condition_earliest:"Frühester",condition_latest:"Spätester"},add_link:{title:"Neue Direktverknüpfung",step_channel:"Schritt 1/3 — Kanal wählen",step_peer:"Schritt 2/3 — Partner wählen",step_confirm:"Schritt 3/3 — Bestätigen",select_channel:"Kanal dieses Geräts auswählen:",select_role:"Rolle des gewählten Kanals:",role_sender:"Sender (sendet Kommandos)",role_receiver:"Empfänger (empfängt Kommandos)",search_devices:"Geräte suchen...",no_compatible:"Keine kompatiblen Kanäle gefunden.",link_name:"Verknüpfungsname (optional)",create:"Verknüpfung erstellen",create_success:"Verknüpfung erfolgreich erstellt.",create_failed:"Fehler beim Erstellen der Verknüpfung.",next:"Weiter",back:"Zurück"},tabs:{devices:"Geräte",integration:"Integration",ccu:"OpenCCU"},integration:{system_health:"Systemzustand",central_state:"Zentralenstatus",health_score:"Gesundheitswert",device_statistics:"Gerätestatistik",total_devices:"Geräte gesamt",unreachable:"Nicht erreichbar",firmware_updatable:"Firmware aktualisierbar",total_short:"gesamt",unreachable_short:"nicht erreichbar",command_throttle:"Befehlsdrosselung",enabled:"Aktiviert",interval:"Intervall",queue_size:"Warteschlange",throttled:"Gedrosselt",burst_count:"Burst-Anzahl",incidents:"Vorfälle",no_incidents:"Keine Vorfälle aufgezeichnet.",clear_incidents:"Vorfälle löschen",clear_incidents_title:"Vorfälle löschen",clear_incidents_text:"Alle aufgezeichneten Vorfälle löschen? Dies kann nicht rückgängig gemacht werden.",incidents_cleared:"Vorfälle gelöscht.",clear:"Löschen",clear_cache:"Cache leeren",clear_cache_title:"Cache leeren",clear_cache_text:"Alle zwischengespeicherten Daten löschen? Die Integration holt die Daten erneut von der CCU.",cache_cleared:"Cache geleert.",actions:"Aktionen",refresh:"Aktualisieren",action_failed:"Aktion fehlgeschlagen."},ccu:{system_information:"Systeminformationen",name:"Name",model:"Modell",version:"Version",serial:"Seriennummer",hostname:"Hostname",ccu_type:"CCU-Typ",interfaces:"Schnittstellen",auth_enabled:"Authentifizierung",update_available:"Update verfügbar",backup_exists:"Backup vorhanden",hub_messages:"Hub-Meldungen",service_messages:"Servicemeldungen",alarm_messages:"Alarmmeldungen",install_mode:"Anlernmodus",active:"Aktiv",inactive:"Inaktiv",remaining_seconds:"Noch {seconds}s",activate:"Aktivieren",install_mode_title:"Anlernmodus aktivieren",install_mode_text:"Anlernmodus für {interface} aktivieren? Die CCU akzeptiert 60 Sekunden lang neue Geräte.",install_mode_activated:"Anlernmodus für {interface} aktiviert.",signal_quality:"Signalqualität",device:"Gerät",interface:"Schnittstelle",reachable:"Erreichbar",signal:"Signal",battery:"Batterie",low:"Schwach",ok:"OK",firmware_overview:"Firmware-Übersicht",updatable:"aktualisierbar",current_fw:"Aktuell",available_fw:"Verfügbar",state:"Status",refresh_firmware:"Firmware-Daten aktualisieren",firmware_refreshed:"Firmware-Daten aktualisiert.",actions:"Aktionen",refresh:"Aktualisieren",create_backup:"Backup erstellen",create_backup_title:"CCU-Backup erstellen",create_backup_text:"Ein Backup der CCU-Konfiguration erstellen? Dies kann einen Moment dauern.",backup_running:"Backup wird erstellt...",backup_success:"Backup erstellt: {filename} ({size} MB)",backup_failed:"Fehler beim Erstellen des Backups.",action_failed:"Aktion fehlgeschlagen.",filter_devices:"Geräte filtern...",filter_all:"Alle",filter_result:"{count} von {total} Geräten"},cross_validation:{max_must_be_gte_min:"Maximum muss größer oder gleich dem Minimum sein.",level_must_be_in_range:"Level muss zwischen Minimum und Maximum liegen.",hi_must_be_gte_lo:"Oberer Schwellwert muss größer oder gleich dem unteren Schwellwert sein."}}};function De(e,t=""){const i={};for(const[s,a]of Object.entries(e)){const e=t?`${t}.${s}`:s;"string"==typeof a?i[e]=a:"object"==typeof a&&null!==a&&Object.assign(i,De(a,e))}return i}const Te=new Map;function Me(e){if(Te.has(e))return Te.get(e);const t=De(Ie[e]??Ie.en);return Te.set(e,t),t}function Pe(e,t,i){const s=Me(e.config.language??"en");let a=s[t]??s[t.replace(/^panel\./,"")]??t;if(i)for(const[e,t]of Object.entries(i))a=a.replace(`{${e}}`,String(t));return a}let Le=class extends oe{constructor(){super(...arguments),this.entryId="",this.entries=[],this._devices=[],this._loading=!1,this._searchQuery="",this._error=""}updated(e){e.has("entryId")&&this.entryId&&this._fetchDevices()}async _fetchDevices(){if(this.entryId){this._loading=!0,this._error="";try{this._devices=await fe(this.hass,this.entryId)}catch(e){this._error=String(e),this._devices=[]}finally{this._loading=!1}}}_l(e,t){return Pe(this.hass,e,t)}get _filteredDevices(){if(!this._searchQuery)return this._devices;const e=this._searchQuery.toLowerCase();return this._devices.filter(t=>t.name.toLowerCase().includes(e)||t.address.toLowerCase().includes(e)||t.model.toLowerCase().includes(e))}get _groupedDevices(){const e=[...this._filteredDevices].sort((e,t)=>e.name.localeCompare(t.name)),t=new Map;for(const i of e){const e=i.interface_id.split("-").slice(1).join("-")||i.interface_id;t.has(e)||t.set(e,[]),t.get(e).push(i)}return t}_handleEntryChanged(e){e.stopPropagation();const t=e.detail.value;t&&t!==this.entryId&&this.dispatchEvent(new CustomEvent("entry-changed",{detail:{entryId:t},bubbles:!0,composed:!0}))}_handleDeviceClick(e){this.dispatchEvent(new CustomEvent("device-selected",{detail:{device:e.address,interfaceId:e.interface_id},bubbles:!0,composed:!0}))}_handleIconError(e){e.target.style.display="none"}_renderMaintenanceIcons(e){return e&&0!==Object.keys(e).length?O`
    ...
    `:j}render(){return O`
      ...
      ${this.entryId?O`
          ...
          `:j}
      ${this._loading?O`<div class="loading"><span>${this._l("common.loading")}</span></div>`:this._error?O`<div class="error">${this._error}</div>`:this.entryId?0===this._filteredDevices.length?O`<div class="empty-state">${this._l("device_list.no_devices")}</div>`:this._renderDeviceGroups():O`<div class="empty-state">${this._l("device_list.no_entry_selected")}</div>`}
    `}_renderDeviceGroups(){return O`
      ${Array.from(this._groupedDevices.entries()).map(([e,t])=>O`
          <div class="interface-group">
            ...
            ${t.map(e=>O`
                <div class="device-card" @click=${()=>this._handleDeviceClick(e)}>
                  ${e.device_icon?O`<img
                        class="device-icon"
                        src=${ge(this.entryId,e.device_icon)}
                        alt=""
    ...
    `]}};function ze(e,t){return new Promise(e=>{const i=document.createElement("dialog");i.style.cssText=["border: none","border-radius: var(--ha-card-border-radius, 12px)","padding: 24px","max-width: 450px","width: calc(100% - 48px)","box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3)","font-family: var(--paper-font-body1_-_font-family, Roboto, sans-serif)","background: var(--card-background-color, var(--ha-card-background, #fff))","color: var(--primary-text-color, #212121)"].join("; ");const s=t.title?`<h2 style="margin: 0 0 16px; font-size: 18px; font-weight: 500;">${Ne(t.title)}</h2>`:"",a=t.text?`<p style="margin: 0 0 24px; white-space: pre-line; line-height: 1.5; color: var(--secondary-text-color, #727272);">${Ne(t.text)}</p>`:"",n=t.destructive?"var(--error-color, #db4437)":"var(--primary-color, #03a9f4)";i.innerHTML=`\n      ${s}\n      ${a}\n      <div style="display: flex; justify-content: flex-end; gap: 8px;">\n        <button class="dismiss" style="\n          padding: 8px 16px;\n          border: none;\n          border-radius: 4px;\n          background: transparent;\n          color: var(--primary-text-color, #212121);\n          font-size: 14px;\n          font-family: inherit;\n          cursor: pointer;\n        ">${Ne(t.dismissText||"Cancel")}</button>\n        <button class="confirm" style="\n          padding: 8px 16px;\n          border: none;\n          border-radius: 4px;\n          background: ${n};\n          color: #fff;\n          font-size: 14px;\n          font-family: inherit;\n          cursor: pointer;\n        ">${Ne(t.confirmText||"OK")}</button>\n      </div>\n    `;const r=t=>{i.close(),i.remove(),e(t)};i.querySelector(".confirm").addEventListener("click",()=>r(!0)),i.querySelector(".dismiss").addEventListener("click",()=>r(!1)),i.addEventListener("cancel",e=>{e.preventDefault(),r(!1)}),document.body.appendChild(i),i.showModal()})}function Ne(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Re(e,t){const i=new CustomEvent("hass-notification",{bubbles:!0,composed:!0,detail:t});e.dispatchEvent(i)}e([pe({attribute:!1})],Le.prototype,"hass",void 0),e([pe()],Le.prototype,"entryId",void 0),e([pe({attribute:!1})],Le.prototype,"entries",void 0),e([_e()],Le.prototype,"_devices",void 0),e([_e()],Le.prototype,"_loading",void 0),e([_e()],Le.prototype,"_searchQuery",void 0),e([_e()],Le.prototype,"_error",void 0),Le=e([ue("hm-device-list")],Le);let Be=class extends oe{constructor(){super(...arguments),this.entryId="",this.interfaceId="",this.deviceAddress="",this._device=null,this._hasSchedule=!1,this._loading=!0,this._error=""}updated(e){(e.has("entryId")||e.has("deviceAddress"))&&this.entryId&&this.deviceAddress&&this._fetchDevice()}async _fetchDevice(){this._loading=!0,this._error="";try{const[e,t]=await Promise.all([fe(this.hass,this.entryId),we(this.hass,this.entryId).catch(()=>[])]);this._device=e.find(e=>e.address===this.deviceAddress)??null,this._hasSchedule=t.some(e=>e.address===this.deviceAddress)}catch(e){this._error=String(e)}finally{this._loading=!1}}_l(e,t){return Pe(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_handleChannelClick(e){this.dispatchEvent(new CustomEvent("channel-selected",{detail:{channel:e.address,interfaceId:this.interfaceId,channelType:e.channel_type,paramsetKey:"MASTER",deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowHistory(){this.dispatchEvent(new CustomEvent("show-history",{detail:{device:this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowLinks(){this.dispatchEvent(new CustomEvent("show-links",{detail:{device:this.deviceAddress,interfaceId:this.interfaceId,deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}_handleShowSchedules(){this.dispatchEvent(new CustomEvent("show-schedules",{detail:{device:this.deviceAddress,interfaceId:this.interfaceId,deviceName:this._device?.name||this.deviceAddress},bubbles:!0,composed:!0}))}async _handleExport(e){try{const t=await async function(e,t,i,s,a="MASTER"){return e.callWS({type:"homematicip_local/config/export_paramset",entry_id:t,interface_id:i,channel_address:s,paramset_key:a})}(this.hass,this.entryId,this.interfaceId,e.address,"MASTER"),i=new Blob([t.json_data],{type:"application/json"}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s,a.download=`${e.address.replace(/:/g,"_")}_MASTER.json`,a.click(),URL.revokeObjectURL(s),Re(this,{message:this._l("device_detail.export_success")})}catch{Re(this,{message:this._l("device_detail.export_failed")})}}async _handleImport(e){const t=document.createElement("input");t.type="file",t.accept=".json",t.onchange=async()=>{const i=t.files?.[0];if(i)try{const t=await i.text();if(!await ze(0,{title:this._l("device_detail.import_confirm_title"),text:this._l("device_detail.import_confirm_text",{channel:e.address}),confirmText:this._l("device_detail.import"),dismissText:this._l("common.cancel")}))return;const s=await async function(e,t,i,s,a,n="MASTER"){return e.callWS({type:"homematicip_local/config/import_paramset",entry_id:t,interface_id:i,channel_address:s,json_data:a,paramset_key:n})}(this.hass,this.entryId,this.interfaceId,e.address,t,"MASTER");Re(this,s.success?{message:this._l("device_detail.import_success")}:{message:this._l("device_detail.import_validation_failed")})}catch{Re(this,{message:this._l("device_detail.import_failed")})}},t.click()}_handleIconError(e){e.target.style.display="none"}render(){if(this._loading)return O`<div class="loading">${this._l("common.loading")}</div>`;if(this._error)return O`<div class="error">${this._error}</div>`;if(!this._device)return O`<div class="empty-state">${this._l("device_detail.not_found")}</div>`;const e=this._device,t=e.channels.find(e=>!e.address.includes(":")),i=e.channels.find(e=>e.address.endsWith(":0")),s=e.channels.filter(e=>e.address.includes(":")&&!e.address.endsWith(":0"));return O`
      <ha-icon-button
        class="back-button"
    ...
    `}_renderDeviceChannel(e){return e.paramset_keys.includes("MASTER")?O`
    ...
    `:j}_renderMaintenanceChannel(e,t){const i=t&&Object.keys(t).length>0,s=e.paramset_keys.includes("MASTER");return O`
    ...
    `}_renderChannel(e){const t=e.address.split(":").pop()??"",i=e.paramset_keys.includes("MASTER");return O`
    ...
    `]}};e([pe({attribute:!1})],Be.prototype,"hass",void 0),e([pe()],Be.prototype,"entryId",void 0),e([pe()],Be.prototype,"interfaceId",void 0),e([pe()],Be.prototype,"deviceAddress",void 0),e([_e()],Be.prototype,"_device",void 0),e([_e()],Be.prototype,"_hasSchedule",void 0),e([_e()],Be.prototype,"_loading",void 0),e([_e()],Be.prototype,"_error",void 0),Be=e([ue("hm-device-detail")],Be);let Ve=class extends oe{constructor(){super(...arguments),this.presets=[],this.allowCustom=!1,this.value=null,this.parameterId="",this._isCustom=!1}firstUpdated(){this._isCustom=!this._isPresetValue(this.value)}render(){this._findPreset(this.value);const e=this._isCustom?"__custom__":String(this.value??"");return O`
      <div class="preset-select">
        <ha-select
          ...
          @closed=${e=>e.stopPropagation()}
        >
          ${this.presets.map(e=>O`
              <ha-list-item .value=${String(e.value)}>${e.label}</ha-list-item>
            `)}
          ${this.allowCustom?O`<ha-list-item value="__custom__">Custom...</ha-list-item>`:j}
        </ha-select>
        ${this._isCustom?O`
              <input
                type="number"
    ...
    `}_isPresetValue(e){return null!=e&&this.presets.some(t=>t.value===e)}_findPreset(e){return this.presets.find(t=>t.value===e)}_handlePresetSelected(e){const t=e.target.value;if("__custom__"===t)return void(this._isCustom=!0);this._isCustom=!1;const i=parseFloat(t);this._dispatchChange(isNaN(i)?t:i)}_handleCustomChange(e){const t=e.target,i=parseFloat(t.value);this._dispatchChange(isNaN(i)?t.value:i)}_dispatchChange(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{parameterId:this.parameterId,value:e,currentValue:this.value},bubbles:!0,composed:!0}))}static{this.styles=r`
    .preset-select {
      display: flex;
      gap: 8px;
      align-items: center;
  ...
  `}};function Ue(e,t){return e.option_labels?.[t]??t}function Fe(e,t,i){return t.options&&"number"==typeof i&&i>=0&&i<t.options.length?Ue(t,t.options[i]):"toggle"===t.widget?Pe(e,i?"form_parameter.toggle_on":"form_parameter.toggle_off"):String(i??"")}e([pe({attribute:!1})],Ve.prototype,"hass",void 0),e([pe({attribute:!1})],Ve.prototype,"presets",void 0),e([pe({type:Boolean})],Ve.prototype,"allowCustom",void 0),e([pe()],Ve.prototype,"value",void 0),e([pe()],Ve.prototype,"parameterId",void 0),e([_e()],Ve.prototype,"_isCustom",void 0),Ve=e([de("hm-form-preset-select")],Ve);let He=class extends oe{constructor(){super(...arguments),this.value=null,this.modified=!1,this.validationError=""}_getDisplayValue(e){return Fe(this.hass,this.parameter,e)}_emitChange(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{parameterId:this.parameter.id,value:e,currentValue:this.parameter.current_value},bubbles:!0,composed:!0}))}render(){const e=this.parameter,t=!e.writable;return O`
      <div class="parameter-row ${t?"read-only":""}">
        <div class="parameter-label">
          ${e.label}
          ${e.unit?O`<span class="parameter-unit">(${e.unit})</span>`:j}
          ${this.modified?O`<span class="modified-dot"></span>`:j}
        </div>
        <div class="parameter-control">${this._renderWidget(e,t)}</div>
      </div>
      ${e.description?O`<ha-markdown
            .content=${e.description}
            class="parameter-description"
          ></ha-markdown>`:j}
      ${this.validationError?O`<div class="validation-error">${this.validationError}</div>`:j}
    `}_renderWidget(e,t){if(e.presets&&e.presets.length>0&&!t)return O`
        ...
        ></hm-form-preset-select>
      `;switch(e.widget){case"toggle":return O`
          <ha-switch
            .checked=${Boolean(this.value)}
            .disabled=${t}
            @change=${e=>{this._emitChange(e.target.checked)}}
          ></ha-switch>
        `;case"slider_with_input":return O`
        ...
        `;case"text_input":return O`
          ...
          />
        `;case"button":return O`
          <ha-button outlined .disabled=${t} @click=${()=>this._emitChange(!0)}>
            ${e.label}
          </ha-button>
        `;default:return O`<span class="read-only-value">${this._getDisplayValue(this.value)}</span>`}}static{this.styles=[ve,r`
      .read-only {
        opacity: 0.7;
      }
    ...
    `]}};e([pe({attribute:!1})],He.prototype,"hass",void 0),e([pe({attribute:!1})],He.prototype,"parameter",void 0),e([pe()],He.prototype,"value",void 0),e([pe({type:Boolean})],He.prototype,"modified",void 0),e([pe()],He.prototype,"validationError",void 0),He=e([ue("hm-form-parameter")],He);let Oe=class extends oe{render(){const e=this.subsetGroup,t=e.current_option_id;return O`
      <div class="subset-select">
        ...
        >
          ${e.options.map(e=>O`
              <ha-list-item .value=${String(e.id)}>${e.label}</ha-list-item>
            `)}
        </ha-select>
      </div>
    `}_handleSelected(e){const t=parseInt(e.target.value,10),i=this.subsetGroup.options.find(e=>e.id===t);if(i)for(const[e,t]of Object.entries(i.values))this.dispatchEvent(new CustomEvent("value-changed",{detail:{parameterId:e,value:t},bubbles:!0,composed:!0}))}static{this.styles=r`
    .subset-select {
      margin: 8px 0;
    }
    .subset-label {
  ...
  `}};e([pe({attribute:!1})],Oe.prototype,"hass",void 0),e([pe({attribute:!1})],Oe.prototype,"subsetGroup",void 0),Oe=e([de("hm-form-subset-select")],Oe);const We=[{unit:0,value:0,label_en:"Not active",label_de:"Nicht aktiv"},{unit:0,value:1,label_en:"100ms",label_de:"100ms"},{unit:0,value:3,label_en:"300ms",label_de:"300ms"},{unit:0,value:5,label_en:"500ms",label_de:"500ms"},{unit:0,value:15,label_en:"1500ms",label_de:"1500ms"},{unit:1,value:1,label_en:"1 second",label_de:"1 Sekunde"},{unit:1,value:2,label_en:"2 seconds",label_de:"2 Sekunden"},{unit:1,value:3,label_en:"3 seconds",label_de:"3 Sekunden"},{unit:1,value:30,label_en:"30 seconds",label_de:"30 Sekunden"},{unit:2,value:1,label_en:"1 minute",label_de:"1 Minute"},{unit:2,value:2,label_en:"2 minutes",label_de:"2 Minuten"},{unit:2,value:4,label_en:"4 minutes",label_de:"4 Minuten"},{unit:2,value:15,label_en:"15 minutes",label_de:"15 Minuten"}];let je=class extends oe{constructor(){super(...arguments),this.pendingChanges=new Map,this.validationErrors={},this._customModePairs=new Set}_getEffectiveValue(e){return this.pendingChanges.has(e.id)?this.pendingChanges.get(e.id):e.current_value}_isModified(e){return this.pendingChanges.has(e.id)}_detectPairs(e){const t=new Map,i=new Set;for(const s of e.parameters)if(s.id.endsWith("_UNIT")&&s.options?.length){const a=s.id.slice(0,-5),n=e.parameters.find(e=>e.id===`${a}_VALUE`);n&&(t.set(a,{unitParam:s,valueParam:n}),i.add(s.id),i.add(n.id))}return{pairs:t,pairedIds:i}}_derivePairLabel(e,t){if("de"===t){if(e.startsWith("Wert "))return e.slice(5)}else if(e.endsWith(" Value"))return e.slice(0,-6);return e}render(){if(!this.schema||!this.schema.sections)return j;const e=new Set,t=this.schema.subset_groups??[];for(const i of t)for(const t of i.member_params)e.add(t);const i=new Set;return O`
      ${this.schema.sections.map(s=>{const{pairs:a,pairedIds:n}=this._detectPairs(s),r=new Set;return O`
          <div class="form-section">
            <div class="section-header">${s.title}</div>
            ${s.parameters.map(s=>{if(r.has(s.id))return j;if(e.has(s.id)){const e=t.find(e=>e.member_params.includes(s.id));return e&&!i.has(e.id)?(i.add(e.id),O`
                    <hm-form-subset-select
                      .hass=${this.hass}
                      .subsetGroup=${e}
                      @value-changed=${this._handleValueChanged}
                    ></hm-form-subset-select>
                  `):j}if(s.visible_when){const e=this._getEffectiveValue({id:s.visible_when.trigger_param,current_value:this._getCurrentParamValue(s.visible_when.trigger_param)})===s.visible_when.trigger_value;if(!(s.visible_when.invert?!e:e))return j}if(n.has(s.id)){const e=s.id.endsWith("_UNIT")?s.id.slice(0,-5):s.id.slice(0,-6),t=a.get(e);if(t)return r.add(t.unitParam.id),r.add(t.valueParam.id),this._renderTimePair(e,t)}return O`
                <hm-form-parameter
                  .hass=${this.hass}
                  .parameter=${s}
        ...
        `})}
    `}_getCurrentParamValue(e){if(this.pendingChanges.has(e))return this.pendingChanges.get(e);for(const t of this.schema?.sections??[]){const i=t.parameters.find(t=>t.id===e);if(i)return i.current_value}}_renderTimePair(e,t){const{unitParam:i,valueParam:s}=t,a=this.hass.config.language??"en",n=Number(this._getEffectiveValue(i)??0),r=Number(this._getEffectiveValue(s)??0),o=this._isModified(i)||this._isModified(s),l=!i.writable||!s.writable,d=this._derivePairLabel(s.label,a),c=We.findIndex(e=>e.unit===n&&e.value===r),h=this._customModePairs.has(e)||c<0,p=h?"custom":String(c);return O`
      <div class="parameter-row ${l?"read-only":""}">
        <div class="parameter-label">
          ${d} ${o?O`<span class="modified-dot"></span>`:j}
        </div>
        <div class="parameter-control">
          <ha-select
            .value=${p}
            .disabled=${l}
            .options=${[...We.map((e,t)=>({value:String(t),label:"de"===a?e.label_de:e.label_en})),{value:"custom",label:Pe(this.hass,"form_parameter.custom_value")}]}
    ...
    `}_renderPairValidationErrors(e,t){const i=this.validationErrors[e.id],s=this.validationErrors[t.id];return i||s?O`
      ${i?O`<div class="validation-error">${i}</div>`:j}
      ${s?O`<div class="validation-error">${s}</div>`:j}
    `:j}_renderCustomFields(e,t){return O`
    ...
    `]}};e([pe({attribute:!1})],je.prototype,"hass",void 0),e([pe({attribute:!1})],je.prototype,"schema",void 0),e([pe({attribute:!1})],je.prototype,"pendingChanges",void 0),e([pe({attribute:!1})],je.prototype,"validationErrors",void 0),je=e([ue("hm-config-form")],je);let Ke=class extends oe{constructor(){super(...arguments),this.entryId="",this.interfaceId="",this.channelAddress="",this.channelType="",this.paramsetKey="MASTER",this.deviceName="",this._schema=null,this._pendingChanges=new Map,this._loading=!0,this._saving=!1,this._error="",this._validationErrors={},this._sessionActive=!1,this._canUndo=!1,this._canRedo=!1}updated(e){(e.has("channelAddress")||e.has("entryId"))&&this.entryId&&this.channelAddress&&this._fetchSchema()}async _fetchSchema(){this._loading=!0,this._error="",this._pendingChanges=new Map,this._validationErrors={},this._canUndo=!1,this._canRedo=!1;try{this._schema=await ye(this.hass,this.entryId,this.interfaceId,this.channelAddress,this.channelType,this.paramsetKey),await be(this.hass,this.entryId,this.interfaceId,this.channelAddress,this.paramsetKey),this._sessionActive=!0}catch(e){this._error=String(e)}finally{this._loading=!1}}_l(e,t){return Pe(this.hass,e,t)}get _isDirty(){return this._pendingChanges.size>0}async _handleValueChanged(e){const{parameterId:t,value:i,currentValue:s}=e.detail;if(i===s?this._pendingChanges.delete(t):this._pendingChanges.set(t,i),this._pendingChanges=new Map(this._pendingChanges),this._sessionActive)try{const e=await async function(e,t,i,s,a,n="MASTER"){return e.callWS({type:"homematicip_local/config/session_set",entry_id:t,channel_address:i,parameter:s,value:a,paramset_key:n})}(this.hass,this.entryId,this.channelAddress,t,i,this.paramsetKey);this._canUndo=e.can_undo,this._canRedo=e.can_redo,this._validationErrors=e.validation_errors}catch{}}async _handleUndo(){if(this._sessionActive)try{const e=await async function(e,t,i,s="MASTER"){return e.callWS({type:"homematicip_local/config/session_undo",entry_id:t,channel_address:i,paramset_key:s})}(this.hass,this.entryId,this.channelAddress,this.paramsetKey);this._canUndo=e.can_undo,this._canRedo=e.can_redo,e.performed&&await this._refreshSchemaValues()}catch(e){this._error=String(e)}}async _handleRedo(){if(this._sessionActive)try{const e=await async function(e,t,i,s="MASTER"){return e.callWS({type:"homematicip_local/config/session_redo",entry_id:t,channel_address:i,paramset_key:s})}(this.hass,this.entryId,this.channelAddress,this.paramsetKey);this._canUndo=e.can_undo,this._canRedo=e.can_redo,e.performed&&await this._refreshSchemaValues()}catch(e){this._error=String(e)}}async _refreshSchemaValues(){try{this._schema=await ye(this.hass,this.entryId,this.interfaceId,this.channelAddress,this.channelType,this.paramsetKey),this._pendingChanges=new Map}catch(e){this._error=String(e)}}_handleDiscard(){this._pendingChanges=new Map,this._validationErrors={},this._sessionActive&&xe(this.hass,this.entryId,this.channelAddress,this.paramsetKey).then(()=>(this._canUndo=!1,this._canRedo=!1,be(this.hass,this.entryId,this.interfaceId,this.channelAddress,this.paramsetKey))).catch(()=>{})}_handleResetDefaults(){if(this._schema){this._pendingChanges=new Map;for(const e of this._schema.sections)for(const t of e.parameters)t.writable&&void 0!==t.default&&t.default!==t.current_value&&this._pendingChanges.set(t.id,t.default);this._pendingChanges=new Map(this._pendingChanges)}}async _handleSave(){if(!this._isDirty||this._saving)return;const e=this._pendingChanges.size,t=[...this._pendingChanges.entries()].map(([e,t])=>{const i=this._findParameter(e);return`${i?.label??e}: ${i?Fe(this.hass,i,i.current_value):"?"} → ${i?Fe(this.hass,i,t):String(t)}`}).join("\n");if(await ze(0,{title:this._l("channel_config.confirm_save_title"),text:`${this._l("channel_config.confirm_save_text",{count:e})}\n\n${t}`,confirmText:this._l("common.save"),dismissText:this._l("common.cancel")})){this._saving=!0,this._validationErrors={};try{if(this._sessionActive){const e=await async function(e,t,i,s,a="MASTER"){return e.callWS({type:"homematicip_local/config/session_save",entry_id:t,interface_id:i,channel_address:s,paramset_key:a})}(this.hass,this.entryId,this.interfaceId,this.channelAddress,this.paramsetKey);e.success?(this._pendingChanges=new Map,this._sessionActive=!1,Re(this,{message:this._l("channel_config.save_success")}),await this._fetchSchema()):Object.keys(e.validation_errors).length>0?(this._validationErrors=e.validation_errors,Re(this,{message:this._l("channel_config.validation_failed")})):Re(this,{message:this._l("channel_config.save_failed")})}else{const e=Object.fromEntries(this._pendingChanges),t=await async function(e,t,i,s,a,n="MASTER",r=!0){return e.callWS({type:"homematicip_local/config/put_paramset",entry_id:t,interface_id:i,channel_address:s,paramset_key:n,values:a,validate:r})}(this.hass,this.entryId,this.interfaceId,this.channelAddress,e,this.paramsetKey);t.success?(this._pendingChanges=new Map,Re(this,{message:this._l("channel_config.save_success")}),await this._fetchSchema()):Object.keys(t.validation_errors).length>0?(this._validationErrors=t.validation_errors,Re(this,{message:this._l("channel_config.validation_failed")})):Re(this,{message:this._l("channel_config.save_failed")})}}catch(e){this._error=String(e),Re(this,{message:this._l("channel_config.save_failed")})}finally{this._saving=!1}}}_findParameter(e){if(this._schema)for(const t of this._schema.sections){const i=t.parameters.find(t=>t.id===e);if(i)return i}}async _handleBack(){if(!this._isDirty||await ze(0,{title:this._l("channel_config.unsaved_title"),text:this._l("channel_config.unsaved_warning"),confirmText:this._l("channel_config.discard"),dismissText:this._l("common.cancel"),destructive:!0})){if(this._sessionActive){try{await xe(this.hass,this.entryId,this.channelAddress,this.paramsetKey)}catch{}this._sessionActive=!1}this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}}_handleIconError(e){e.target.style.display="none"}render(){return this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:this._error&&!this._schema?O`<div class="error">${this._error}</div>`:O`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
      ...
      <div class="config-header">
        ${this._schema?.device_icon?O`<img
              class="device-icon"
              src=${ge(this.entryId,this._schema.device_icon)}
              alt=""
              @error=${this._handleIconError}
            />`:j}
        <div class="config-header-text">
          ${this.deviceName?O`<h2>${this.deviceName}</h2>`:j}
          <div class="device-info">
            ${this.channelAddress} —
      ...
      ${this._error?O`<div class="error">${this._error}</div>`:j}
      ${this._schema?O`
            <hm-config-form
              .hass=${this.hass}
              .schema=${this._schema}
    ...
    `]}};e([pe({attribute:!1})],Ke.prototype,"hass",void 0),e([pe()],Ke.prototype,"entryId",void 0),e([pe()],Ke.prototype,"interfaceId",void 0),e([pe()],Ke.prototype,"channelAddress",void 0),e([pe()],Ke.prototype,"channelType",void 0),e([pe()],Ke.prototype,"paramsetKey",void 0),e([pe()],Ke.prototype,"deviceName",void 0),e([_e()],Ke.prototype,"_schema",void 0),e([_e()],Ke.prototype,"_pendingChanges",void 0),e([_e()],Ke.prototype,"_loading",void 0),e([_e()],Ke.prototype,"_saving",void 0),e([_e()],Ke.prototype,"_error",void 0),e([_e()],Ke.prototype,"_validationErrors",void 0),e([_e()],Ke.prototype,"_sessionActive",void 0),e([_e()],Ke.prototype,"_canUndo",void 0),e([_e()],Ke.prototype,"_canRedo",void 0),Ke=e([ue("hm-channel-config")],Ke);let Ye=class extends oe{constructor(){super(...arguments),this.entryId="",this.filterDevice="",this._entries=[],this._total=0,this._loading=!0,this._error="",this._expandedEntries=new Set}updated(e){(e.has("entryId")||e.has("filterDevice"))&&this.entryId&&this._fetchHistory()}async _fetchHistory(){this._loading=!0,this._error="";try{const e=await async function(e,t,i="",s=50){return e.callWS({type:"homematicip_local/config/get_change_history",entry_id:t,channel_address:i,limit:s})}(this.hass,this.entryId,this.filterDevice);this._entries=e.entries,this._total=e.total}catch(e){this._error=String(e)}finally{this._loading=!1}}_l(e,t){return Pe(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_toggleEntry(e){const t=new Set(this._expandedEntries);t.has(e)?t.delete(e):t.add(e),this._expandedEntries=t}async _handleClear(){if(await ze(0,{title:this._l("change_history.clear_confirm_title"),text:this._l("change_history.clear_confirm_text"),confirmText:this._l("change_history.clear"),dismissText:this._l("common.cancel"),destructive:!0}))try{const e=await async function(e,t){return e.callWS({type:"homematicip_local/config/clear_change_history",entry_id:t})}(this.hass,this.entryId);e.success&&(Re(this,{message:this._l("change_history.clear_success",{count:e.cleared})}),this._entries=[],this._total=0)}catch{Re(this,{message:this._l("channel_config.save_failed")})}}_formatTimestamp(e){try{return new Date(e).toLocaleString(this.hass.config.language||"en")}catch{return e}}_getSourceLabel(e){switch(e){case"manual":return this._l("change_history.source_manual");case"import":return this._l("change_history.source_import");case"copy":return this._l("change_history.source_copy");default:return e}}render(){return O`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
      ...
      ${this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:this._error?O`<div class="error">${this._error}</div>`:0===this._entries.length?O`<div class="empty-state">${this._l("change_history.empty")}</div>`:this._renderEntries()}
      ${!this._loading&&this._entries.length>0?O`
          ...
          `:j}
    `}_renderEntries(){return O`
      <div class="history-list">
        ${this._entries.map((e,t)=>{const i=`${e.timestamp}-${t}`,s=this._expandedEntries.has(i),a=Object.keys(e.changes).length;return O`
            <div class="history-entry">
              ...
              ${s?O`
                    <div class="history-details">
                      ${Object.entries(e.changes).map(([e,t])=>O`
    ...
    `]}};e([pe({attribute:!1})],Ye.prototype,"hass",void 0),e([pe()],Ye.prototype,"entryId",void 0),e([pe()],Ye.prototype,"filterDevice",void 0),e([_e()],Ye.prototype,"_entries",void 0),e([_e()],Ye.prototype,"_total",void 0),e([_e()],Ye.prototype,"_loading",void 0),e([_e()],Ye.prototype,"_error",void 0),e([_e()],Ye.prototype,"_expandedEntries",void 0),Ye=e([ue("hm-change-history")],Ye);let Ze=class extends oe{constructor(){super(...arguments),this.entryId="",this.interfaceId="",this.deviceAddress="",this.deviceName="",this._links=[],this._loading=!0,this._error=""}updated(e){(e.has("entryId")||e.has("deviceAddress")||e.has("interfaceId"))&&this.entryId&&this.deviceAddress&&this.interfaceId&&this._fetchLinks()}async _fetchLinks(){this._loading=!0,this._error="";try{this._links=await async function(e,t,i,s){return(await e.callWS({type:"homematicip_local/config/list_device_links",entry_id:t,interface_id:i,device_address:s})).links}(this.hass,this.entryId,this.interfaceId,this.deviceAddress)}catch(e){this._error=String(e)}finally{this._loading=!1}}_l(e,t){return Pe(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_handleAddLink(){this.dispatchEvent(new CustomEvent("add-link",{detail:{deviceAddress:this.deviceAddress,interfaceId:this.interfaceId},bubbles:!0,composed:!0}))}_handleConfigure(e){this.dispatchEvent(new CustomEvent("configure-link",{detail:{senderAddress:e.sender_address,receiverAddress:e.receiver_address,interfaceId:this.interfaceId,senderDeviceName:e.sender_device_name,senderDeviceModel:e.sender_device_model,senderChannelTypeLabel:e.sender_channel_type_label,receiverDeviceName:e.receiver_device_name,receiverDeviceModel:e.receiver_device_model,receiverChannelTypeLabel:e.receiver_channel_type_label},bubbles:!0,composed:!0}))}async _handleDelete(e){if(await ze(0,{title:this._l("device_links.delete_confirm_title"),text:this._l("device_links.delete_confirm_text",{sender:e.sender_address,receiver:e.receiver_address}),confirmText:this._l("device_links.delete"),dismissText:this._l("common.cancel"),destructive:!0}))try{await async function(e,t,i,s){return e.callWS({type:"homematicip_local/config/remove_link",entry_id:t,sender_channel_address:i,receiver_channel_address:s})}(this.hass,this.entryId,e.sender_address,e.receiver_address),Re(this,{message:this._l("device_links.delete_success")}),await this._fetchLinks()}catch{Re(this,{message:this._l("device_links.delete_failed")})}}_groupByChannel(){const e=new Map;for(const t of this._links){const i=(t.sender_address.startsWith(this.deviceAddress)?t.sender_address:t.receiver_address).split(":").pop()??"";e.has(i)||e.set(i,[]),e.get(i).push(t)}return e}render(){return O`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
      ...
      ${this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:this._error?O`<div class="error">${this._error}</div>`:0===this._links.length?O`<div class="empty-state">${this._l("device_links.empty")}</div>`:this._renderGroupedLinks()}
    `}_renderGroupedLinks(){const e=this._groupByChannel(),t=[...e.keys()].sort((e,t)=>parseInt(e)-parseInt(t));return O`
      ${t.map(t=>{const i=e.get(t);return O`
        ...
        `})}
    `}_renderLinkCard(e){const t="outgoing"===e.direction;return O`
          ...
          <div class="link-endpoints">
            <div class="link-endpoint-info">
              ...
              <span class="link-device-detail">
                ${e.sender_device_model}${e.sender_channel_type_label?O` · ${e.sender_channel_type_label}`:j}
              </span>
            ...
            <div class="link-endpoint-info">
              ...
              <span class="link-device-detail">
                ${e.receiver_device_model}${e.receiver_channel_type_label?O` · ${e.receiver_channel_type_label}`:j}
              </span>
              <span class="link-endpoint-address">${e.receiver_address}</span>
            </div>
          </div>
          ${e.name?O`<div class="link-name">"${e.name}"</div>`:j}
        </div>
    ...
    `}_renderParamList(e){const t=new Map,i=[];for(const s of e)if(s.time_pair_id&&s.id.toUpperCase().endsWith("_TIME_BASE")){const e=t.get(s.time_pair_id)??{};e.base=s,t.set(s.time_pair_id,e)}else if(s.time_pair_id&&s.id.toUpperCase().endsWith("_TIME_FACTOR")){const e=t.get(s.time_pair_id)??{};e.factor=s,t.set(s.time_pair_id,e)}else s.hidden_by_default&&0!==this._selectedProfileId||i.push(s);return O`
      ${[...t.entries()].map(([,e])=>e.base&&e.factor?O`
              ...
              ></hm-time-selector>
            `:j)}
      ${i.map(e=>e.display_as_percent&&e.has_last_value?this._renderLevelParam(e):O`
              <hm-form-parameter
                .hass=${this.hass}
                .parameter=${e}
                .value=${this._getEffectiveValue(e)}
              ...
              ></hm-form-parameter>
            `)}
    `}_renderLevelParam(e){const t=this._getEffectiveValue(e),i=t>1,s=i?100:Math.round(100*t);return O`
      <div class="level-param">
        <div class="parameter-row">
          <div class="parameter-label">
            ${e.label}
            ${this._isModified(e)?O`<span class="modified-dot"></span>`:j}
          </div>
    ...
    `}_renderReceiverParams(){const e=this._groupedReceiverParams;if(e){const t=e.short.length>0,i=e.long.length>0,s=t&&i;return O`
        <div class="param-section">
          ...
          ${e.common.length>0?O` <div class="common-params">${this._renderParamList(e.common)}</div> `:j}
        </div>
      `}return O`
      <div class="param-section">
        <h3>${this._l("link_config.receiver_params")}</h3>
    ...
    `}render(){return this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:!this._error||this._receiverSchema||this._senderSchema?O`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
      ...
      <div class="config-header">
        ...
        <div class="link-info-bar">
          <div class="link-endpoint">
            ...
            ${this.senderDeviceName?O`<span class="link-device-name">${this.senderDeviceName}</span>`:j}
            ${this.senderDeviceModel||this.senderChannelTypeLabel?O`<span class="link-device-detail">
                  ${this.senderDeviceModel}${this.senderChannelTypeLabel?O` &middot; ${this.senderChannelTypeLabel}`:j}
                </span>`:j}
          ...
          <div class="link-endpoint">
            ...
            ${this.receiverDeviceName?O`<span class="link-device-name">${this.receiverDeviceName}</span>`:j}
            ${this.receiverDeviceModel||this.receiverChannelTypeLabel?O`<span class="link-device-detail">
                  ${this.receiverDeviceModel}${this.receiverChannelTypeLabel?O` &middot; ${this.receiverChannelTypeLabel}`:j}
                </span>`:j}
      ...
      ${this._hasSenderParams()?O`
          ...
          `:j}
      ${this._hasReceiverParams()||this._hasSenderParams()?j:O`<div class="empty-state">${this._l("link_config.no_params")}</div>`}
    ...
    `:O`<div class="error">${this._error}</div>`}static{this.styles=[ve,r`
      .config-header {
        margin-bottom: 16px;
      }
    ...
    `}_renderStepChannel(){const e=this._getLinkableChannels();return O`
      <div class="wizard-step">
        ...
        <div class="radio-list">
          ${0===e.length?O`<div class="empty-state">${this._l("add_link.no_compatible")}</div>`:e.map(e=>{const t=e.address.split(":").pop()??"",i=this._selectedChannel===e.address;return O`
                  <div
    ...
    `}_renderStepPeer(){return O`
      <div class="wizard-step">
        ...
        ${this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:O`
              ...
              <div class="radio-list">
                ${0===this._filteredChannels.length?O`<div class="empty-state">${this._l("add_link.no_compatible")}</div>`:this._filteredChannels.map(e=>{const t=this._selectedPeer===e.address;return O`
                        <div
              ...
              ${this._filteredChannels.length>0?O`
                    <div class="wizard-actions">
                      <ha-button
                        raised
    ...
    `}_renderStepConfirm(){const e="sender"===this._selectedRole?this._selectedChannel:this._selectedPeer,t="sender"===this._selectedRole?this._selectedPeer:this._selectedChannel,i=this._resolveName(e),s=this._resolveName(t);return O`
      <div class="wizard-step">
    ...
    `}_resolveName(e){if(!this._device)return e;if(e.startsWith(this.deviceAddress))return this._device.name||this.deviceAddress;const t=this._linkableChannels.find(t=>t.address===e);return t?`${t.device_name} (${t.device_model})`:e}static{this.styles=[ve,r`
      .wizard-header {
        margin-bottom: 16px;
      }
    ...
    `]}};function Je(e){return t=>(customElements.get(e)||customElements.define(e,t),t)}e([pe({attribute:!1})],Qe.prototype,"hass",void 0),e([pe()],Qe.prototype,"entryId",void 0),e([pe()],Qe.prototype,"interfaceId",void 0),e([pe()],Qe.prototype,"deviceAddress",void 0),e([_e()],Qe.prototype,"_step",void 0),e([_e()],Qe.prototype,"_device",void 0),e([_e()],Qe.prototype,"_selectedChannel",void 0),e([_e()],Qe.prototype,"_selectedRole",void 0),e([_e()],Qe.prototype,"_selectedPeer",void 0),e([_e()],Qe.prototype,"_linkName",void 0),e([_e()],Qe.prototype,"_linkableChannels",void 0),e([_e()],Qe.prototype,"_filteredChannels",void 0),e([_e()],Qe.prototype,"_searchQuery",void 0),e([_e()],Qe.prototype,"_loading",void 0),e([_e()],Qe.prototype,"_error",void 0),Qe=e([ue("hm-add-link")],Qe);let Xe=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};const{I:et}=ae,tt=e=>e,it=()=>document.createComment(""),st=(e,t,i)=>{const s=e._$AA.parentNode,a=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(it(),a),n=s.insertBefore(it(),a);i=new et(t,n,e,e.options)}else{const t=i._$AB.nextSibling,n=i._$AM,r=n!==e;if(r){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==n._$AU&&i._$AP(t)}if(t!==a||r){let e=i._$AA;for(;e!==t;){const t=tt(e).nextSibling;tt(s).insertBefore(e,a),e=t}}}return i},at=(e,t,i=e)=>(e._$AI(t,i),e),nt={},rt=(e,t=nt)=>e._$AH=t,ot=e=>{e._$AR(),e._$AA.remove()},lt=(e,t,i)=>{const s=new Map;for(let a=t;a<=i;a++)s.set(e[a],a);return s},dt=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Xe{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const a=[],n=[];let r=0;for(const t of e)a[r]=s?s(t,r):r,n[r]=i(t,r),r++;return{values:n,keys:a}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const a=(e=>e._$AH)(e),{values:n,keys:r}=this.dt(t,i,s);if(!Array.isArray(a))return this.ut=r,n;const o=this.ut??=[],l=[];let d,c,h=0,p=a.length-1,_=0,u=n.length-1;for(;h<=p&&_<=u;)if(null===a[h])h++;else if(null===a[p])p--;else if(o[h]===r[_])l[_]=at(a[h],n[_]),h++,_++;else if(o[p]===r[u])l[u]=at(a[p],n[u]),p--,u--;else if(o[h]===r[u])l[u]=at(a[h],n[u]),st(e,l[u+1],a[h]),h++,u--;else if(o[p]===r[_])l[_]=at(a[p],n[_]),st(e,a[h],a[p]),p--,_++;else if(void 0===d&&(d=lt(r,_,u),c=lt(o,h,p)),d.has(o[h]))if(d.has(o[p])){const t=c.get(r[_]),i=void 0!==t?a[t]:null;if(null===i){const t=st(e,a[h]);at(t,n[_]),l[_]=t}else l[_]=at(i,n[_]),st(e,a[h],i),a[t]=null;_++}else ot(a[p]),p--;else ot(a[h]),h++;for(;_<=u;){const t=st(e,l[u+1]);at(t,n[_]),l[_++]=t}for(;h<=p;){const e=a[h++];null!==e&&ot(e)}return this.ut=r,rt(e,l),W}}),ct=["MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY","SUNDAY"],ht=["fixed_time","astro","fixed_if_before_astro","astro_if_before_fixed","fixed_if_after_astro","astro_if_after_fixed","earliest","latest"],pt={switch:{levelType:"binary",hasLevel2:!1,hasDuration:!0,hasRampTime:!1},light:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!0},cover:{levelType:"percentage",hasLevel2:!0,hasDuration:!1,hasRampTime:!1},valve:{levelType:"percentage",hasLevel2:!1,hasDuration:!0,hasRampTime:!1}},_t=["ms","s","min","h"];function ut(e){const[t,i]=e.split(":").map(Number);return 60*t+i}function vt(e){const t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}function mt(e,t="24"){if("24"===t)return e;const[i,s]=e.split(":");let a=parseInt(i,10);if(24===a)return"12:00 AM";const n=a>=12?"PM":"AM";return 0===a?a=12:a>12&&(a-=12),`${a}:${s||"00"} ${n}`}function gt(e){return e<10?"#2b9af9":e<14?"#40c4ff":e<17?"#26c6da":e<19?"#66bb6a":e<21?"#9ccc65":e<23?"#ffb74d":e<25?"#ff8100":"#f4511e"}function ft(e){const{base_temperature:t,periods:i}=e,s=[],a=[...i].sort((e,t)=>ut(e.starttime)-ut(t.starttime));for(let e=0;e<a.length;e++){const t=a[e];s.push({startTime:t.starttime,startMinutes:ut(t.starttime),endTime:t.endtime,endMinutes:ut(t.endtime),temperature:t.temperature,slot:e+1})}return{blocks:s,baseTemperature:t}}function yt(e,t){const i=[],s=[...e].sort((e,t)=>e.startMinutes-t.startMinutes);for(const e of s)i.push({starttime:e.startTime,endtime:e.endTime,temperature:e.temperature});return{base_temperature:t,periods:i}}function bt(e){if(0===e.length)return[];const t=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),i=[];let s={...t[0]};for(let e=1;e<t.length;e++){const a=t[e];s.endMinutes===a.startMinutes&&s.temperature===a.temperature?s={...s,endTime:a.endTime,endMinutes:a.endMinutes}:(i.push(s),s={...a})}return i.push(s),i.map((e,t)=>({...e,slot:t+1}))}function xt(e,t){if(0===e.length)return[{startTime:"00:00",startMinutes:0,endTime:"24:00",endMinutes:1440,temperature:t,slot:1}];const i=[...e].sort((e,t)=>e.startMinutes-t.startMinutes),s=[];let a=0;for(const e of i)e.startMinutes>a&&s.push({startTime:vt(a),startMinutes:a,endTime:e.startTime,endMinutes:e.startMinutes,temperature:t,slot:s.length+1}),s.push({...e,slot:s.length+1}),a=e.endMinutes;return a<1440&&s.push({startTime:vt(a),startMinutes:a,endTime:"24:00",endMinutes:1440,temperature:t,slot:s.length+1}),bt(s)}function $t(e){return[...e].sort((e,t)=>e.startMinutes-t.startMinutes).map((e,t)=>({...e,slot:t+1}))}function kt(e){return Boolean(Array.isArray(e.weekdays)&&e.weekdays.length>0&&Array.isArray(e.target_channels)&&e.target_channels.length>0)}function wt(e){return"fixed_time"!==e}const St=/^(\d+(?:\.\d+)?)\s*(ms|s|min|h)$/;function Ct(e){const t=e.trim().match(St);return t?{value:parseFloat(t[1]),unit:t[2]}:null}function Et(e,t){return`${e}${t}`}function At(e){return St.test(e.trim())}function It(e){const t={weekdays:e.weekdays,time:e.time,target_channels:e.target_channels,level:e.level};return"fixed_time"!==e.condition&&(t.condition=e.condition),null!==e.astro_type&&(t.astro_type=e.astro_type),0!==e.astro_offset_minutes&&(t.astro_offset_minutes=e.astro_offset_minutes),null!==e.level_2&&(t.level_2=e.level_2),null!==e.duration&&(t.duration=e.duration),null!==e.ramp_time&&(t.ramp_time=e.ramp_time),t}function Dt(e){const t={};for(const[i,s]of Object.entries(e))t[i]=It(s);return t}function Tt(e,t=5,i=30.5){const{base_temperature:s,periods:a}=e;if(s<t||s>i)return{key:"temperatureOutOfRange",params:{block:"base",min:`${t}`,max:`${i}`}};let n=0;for(let e=0;e<a.length;e++){const s=a[e];if(!s.starttime||!s.endtime||void 0===s.temperature)return{key:"slotMissingValues",params:{slot:`${e+1}`}};const r=ut(s.starttime),o=ut(s.endtime);if(o<=r)return{key:"blockEndBeforeStart",params:{block:`${e+1}`}};if(r<n)return{key:"slotTimeBackwards",params:{slot:`${e+1}`,time:s.starttime}};if(s.temperature<t||s.temperature>i)return{key:"temperatureOutOfRange",params:{block:`${e+1}`,min:`${t}`,max:`${i}`}};n=o}return null}const Mt=r`
  :host {
    display: block;
  }
...
`;var Pt=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Lt=class extends oe{constructor(){super(...arguments),this.editable=!1,this.showTemperature=!0,this.showGradient=!1,this.temperatureUnit="°C",this.hourFormat="24",this.editorOpen=!1,this._currentTimePercent=0,this._currentTimeMinutes=0}connectedCallback(){super.connectedCallback(),this._updateCurrentTime(),this._timeUpdateInterval=window.setInterval(()=>{this._updateCurrentTime()},6e4)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._timeUpdateInterval&&(clearInterval(this._timeUpdateInterval),this._timeUpdateInterval=void 0)}willUpdate(e){super.willUpdate(e)}_updateCurrentTime(){const e=new Date,t=60*e.getHours()+e.getMinutes();this._currentTimePercent=t/1440*100,this._currentTimeMinutes=t;const i=e.getDay();this._currentWeekday=["SUNDAY","MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY"][i]}_isBlockActive(e,t){return!(!this._currentWeekday||this._currentWeekday!==e)&&this._currentTimeMinutes>=t.startMinutes&&this._currentTimeMinutes<t.endMinutes}_getTimeLabels(){const e=[];for(let t=0;t<=24;t+=3){const i=`${t.toString().padStart(2,"0")}:00`;e.push({hour:t,label:mt(i,this.hourFormat),position:t/24*100})}return e}_formatTimeDisplay(e){return mt(e,this.hourFormat)}_getBaseTemperature(e){if(this.scheduleData){const t=this.scheduleData[e];if(t){const{baseTemperature:e}=ft(t);return e}}return 20}_getParsedBlocks(e){if(this.scheduleData){const t=this.scheduleData[e];if(!t)return[];const{blocks:i}=ft(t);return i}return[]}_getWeekdayLabel(e){return this.translations?.weekdayShortLabels[e]??e.slice(0,2)}_handleWeekdayClick(e){this.editable&&this.dispatchEvent(new CustomEvent("weekday-click",{detail:{weekday:e},bubbles:!0,composed:!0}))}_handleCopy(e,t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("copy-schedule",{detail:{weekday:e},bubbles:!0,composed:!0}))}_handlePaste(e,t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("paste-schedule",{detail:{weekday:e},bubbles:!0,composed:!0}))}render(){return this.scheduleData?O`
      <div class="schedule-container">
        ...
        <div class="time-axis-labels">
          ${dt(this._getTimeLabels(),e=>e.hour,e=>O`
        ...
        <div class="schedule-content">
          ${dt(ct,e=>`${e}-${this.currentProfile}-${this.scheduleDataHash}`,e=>{const t=this._getParsedBlocks(e),i=this._getBaseTemperature(e),s=xt(t,i);return O`
                <div
                  class="time-blocks ${this.editable?"editable":""}"
                  @click=${()=>this._handleWeekdayClick(e)}
                >
                  ${dt(s,e=>`${e.slot}-${e.startMinutes}-${this.currentProfile}`,(a,n)=>{const r=this._isBlockActive(e,a),o=a.temperature===i&&!t.some(e=>e.startMinutes===a.startMinutes&&e.endMinutes===a.endMinutes);let l;if(o)l="background-color: var(--secondary-background-color, #e0e0e0);";else if(this.showGradient){l=`background: ${function(e,t,i){const s=gt(e);return null===t&&null===i?s:null!==t&&null===i?`linear-gradient(to bottom, ${gt(t)}, ${s})`:null===t&&null!==i?`linear-gradient(to bottom, ${s}, ${gt(i)})`:`linear-gradient(to bottom, ${gt(t)}, ${s} 50%, ${gt(i)})`}(a.temperature,n>0?s[n-1].temperature:null,n<s.length-1?s[n+1].temperature:null)};`}else l=`background-color: ${gt(a.temperature)};`;return O`
                        <div
                          ...
                          style="
                            ...
                            "
                        >
                          ${this.showTemperature?O`<span class="temperature"
      ...
      ${this.editable?O`<div class="hint">${this.translations?.clickToEdit??""}</div>`:""}
    `:O``}static{this.styles=Mt}};Pt([pe({attribute:!1})],Lt.prototype,"scheduleData",void 0),Pt([pe({type:Boolean})],Lt.prototype,"editable",void 0),Pt([pe({type:Boolean})],Lt.prototype,"showTemperature",void 0),Pt([pe({type:Boolean})],Lt.prototype,"showGradient",void 0),Pt([pe({type:String})],Lt.prototype,"temperatureUnit",void 0),Pt([pe({type:String})],Lt.prototype,"hourFormat",void 0),Pt([pe({attribute:!1})],Lt.prototype,"translations",void 0),Pt([pe({type:String})],Lt.prototype,"copiedWeekday",void 0),Pt([pe({type:Boolean})],Lt.prototype,"editorOpen",void 0),Pt([pe({type:String})],Lt.prototype,"currentProfile",void 0),Pt([pe({type:String})],Lt.prototype,"scheduleDataHash",void 0),Pt([_e()],Lt.prototype,"_currentTimePercent",void 0),Pt([_e()],Lt.prototype,"_currentTimeMinutes",void 0),Pt([_e()],Lt.prototype,"_currentWeekday",void 0),Lt=Pt([Je("hmip-schedule-grid")],Lt);const zt=r`
  :host {
    display: block;
  }
...
`;var Nt=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Rt=class extends oe{constructor(){super(),this.open=!1,this.minTemp=5,this.maxTemp=30.5,this.tempStep=.5,this.temperatureUnit="°C",this.hourFormat="24",this._validationWarnings=[],this._historyStack=[],this._historyIndex=-1,this._keyDownHandler=this._handleKeyDown.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._keyDownHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._keyDownHandler)}willUpdate(e){if(super.willUpdate(e),(e.has("open")||e.has("weekday"))&&this.open&&this.weekday){const t=e.get("open"),i=e.get("weekday");(!t&&this.open||this.open&&i!==this.weekday)&&this._initializeEditor(this.weekday)}}_initializeEditor(e){this._editingWeekday=e,this._editingBlocks=this._getParsedBlocks(e),this._editingSlotIndex=void 0,this._editingSlotData=void 0;const t=this.scheduleData?.[e];if(t){const{baseTemperature:e}=ft(t);this._editingBaseTemperature=e}else this._editingBaseTemperature=20;this._historyStack=[JSON.parse(JSON.stringify(this._editingBlocks))],this._historyIndex=0,this._updateValidationWarnings()}_getParsedBlocks(e){if(this.scheduleData){const t=this.scheduleData[e];if(!t)return[];const{blocks:i}=ft(t);return i}return[]}_getWeekdayLabel(e,t){return"long"===t?this.translations?.weekdayLongLabels[e]??e:this.translations?.weekdayShortLabels[e]??e.slice(0,2)}_formatTimeDisplay(e){return mt(e,this.hourFormat)}_formatValidationParams(e){if(!e)return{};const t={};for(const[i,s]of Object.entries(e))"weekday"===i&&ct.includes(s)?t.weekday=this._getWeekdayLabel(s,"long"):t[i]=s;return t}_translateValidationMessage(e){const t=this.translations?.validationMessages[e.key]||e.key,i=this._formatValidationParams(e.params);e.nested&&(i.details=this._translateValidationMessage(e.nested));let s=t;for(const[e,t]of Object.entries(i))s=s.replace(`{${e}}`,t);return s}_saveHistoryState(){if(!this._editingBlocks)return;const e=JSON.parse(JSON.stringify(this._editingBlocks));this._historyStack=this._historyStack.slice(0,this._historyIndex+1),this._historyStack.push(e),this._historyIndex++,this._historyStack.length>50&&(this._historyStack.shift(),this._historyIndex--)}_undo(){this._historyIndex<=0||(this._historyIndex--,this._editingBlocks=JSON.parse(JSON.stringify(this._historyStack[this._historyIndex])),this._updateValidationWarnings())}_redo(){this._historyIndex>=this._historyStack.length-1||(this._historyIndex++,this._editingBlocks=JSON.parse(JSON.stringify(this._historyStack[this._historyIndex])),this._updateValidationWarnings())}_canUndo(){return this._historyIndex>0}_canRedo(){return this._historyIndex<this._historyStack.length-1}_handleKeyDown(e){if(!this.open||!this._editingWeekday||!this._editingBlocks)return;const t=e.ctrlKey||e.metaKey;t&&"z"===e.key&&!e.shiftKey?(e.preventDefault(),this._undo()):t&&("y"===e.key||"z"===e.key&&e.shiftKey)&&(e.preventDefault(),this._redo())}_updateValidationWarnings(){this._validationWarnings=this._editingBlocks?function(e,t=5,i=30.5){const s=[];if(0===e.length)return s;for(let t=0;t<e.length-1;t++){const i=e[t];i.endMinutes<i.startMinutes&&s.push({key:"blockEndBeforeStart",params:{block:`${t+1}`}}),i.endMinutes===i.startMinutes&&s.push({key:"blockZeroDuration",params:{block:`${t+1}`}})}const a=e[e.length-1];return a.endMinutes<a.startMinutes&&s.push({key:"blockEndBeforeStart",params:{block:`${e.length}`}}),e.forEach((e,a)=>{(e.startMinutes<0||e.startMinutes>1440)&&s.push({key:"invalidStartTime",params:{block:`${a+1}`}}),(e.endMinutes<0||e.endMinutes>1440)&&s.push({key:"invalidEndTime",params:{block:`${a+1}`}}),(e.temperature<t||e.temperature>i)&&s.push({key:"temperatureOutOfRange",params:{block:`${a+1}`,min:`${t}`,max:`${i}`}})}),s}(this._editingBlocks,this.minTemp,this.maxTemp):[]}_startSlotEdit(e){if(!this._editingBlocks||e<0||e>=this._editingBlocks.length)return;const t=this._editingBlocks[e];this._editingSlotIndex=e,this._editingSlotData={startTime:t.startTime,endTime:t.endTime,temperature:t.temperature}}_startSlotEditFromDisplay(e,t){if(!this._editingBlocks)return;const i=t[e],s=this._editingBlocks.findIndex(e=>e.startMinutes===i.startMinutes&&e.endMinutes===i.endMinutes&&e.temperature===i.temperature);-1!==s&&this._startSlotEdit(s)}_cancelSlotEdit(){this._editingSlotIndex=void 0,this._editingSlotData=void 0}_saveSlotEdit(){if(void 0===this._editingSlotIndex||!this._editingSlotData||!this._editingBlocks||void 0===this._editingBaseTemperature)return;const e=this._editingSlotIndex,{startTime:t,endTime:i,temperature:s}=this._editingSlotData,a={startTime:t,startMinutes:ut(t),endTime:i,endMinutes:ut(i),temperature:s,slot:e+1},n=this._editingBlocks.filter((t,i)=>i!==e),r=function(e,t){const i=[],s=t.startMinutes,a=t.endMinutes,n=[...e].sort((e,t)=>e.startMinutes-t.startMinutes);for(const e of n){const t=e.startMinutes,n=e.endMinutes;n<=s||t>=a?i.push(e):(t<s&&i.push({...e,endTime:vt(s),endMinutes:s,slot:i.length+1}),n>a&&i.push({...e,startTime:vt(a),startMinutes:a,slot:i.length+1}))}i.push({...t,slot:i.length+1});const r=i.sort((e,t)=>e.startMinutes-t.startMinutes);return bt(r)}(n,a),o=bt($t(r));this._saveHistoryState(),this._editingBlocks=o,this._editingSlotIndex=void 0,this._editingSlotData=void 0,this._updateValidationWarnings()}_addNewSlot(){if(!this._editingBlocks||void 0===this._editingBaseTemperature)return;if(this._editingBlocks.length>=12)return;let e=0,t=60;if(this._editingBlocks.length>0){const i=$t(this._editingBlocks),s=i[i.length-1];if(s.endMinutes<1440)e=s.endMinutes,t=Math.min(e+60,1440);else{let s=!1;for(let a=0;a<i.length;a++){const n=0===a?0:i[a-1].endMinutes;if(i[a].startMinutes>n){e=n,t=i[a].startMinutes,s=!0;break}}if(!s)return}}const i=Math.min(this._editingBaseTemperature+2,this.maxTemp),s={startTime:vt(e),startMinutes:e,endTime:vt(t),endMinutes:t,temperature:i,slot:this._editingBlocks.length+1};this._saveHistoryState();const a=$t([...this._editingBlocks,s]);this._editingBlocks=a;const n=a.findIndex(i=>i.startMinutes===e&&i.endMinutes===t);n>=0&&this._startSlotEdit(n),this._updateValidationWarnings()}_removeTimeBlockByIndex(e,t){if(!this._editingBlocks||void 0===this._editingBaseTemperature)return;const i=t[e],s=this._editingBlocks.findIndex(e=>e.startMinutes===i.startMinutes&&e.endMinutes===i.endMinutes&&e.temperature===i.temperature);if(-1===s)return;this._saveHistoryState();const a=this._editingBlocks.filter((e,t)=>t!==s);this._editingBlocks=bt($t(a)),this._updateValidationWarnings()}_switchToWeekday(e){e!==this._editingWeekday&&this._initializeEditor(e)}_closeEditor(){this._editingWeekday=void 0,this._editingBlocks=void 0,this._editingBaseTemperature=void 0,this._editingSlotIndex=void 0,this._editingSlotData=void 0,this._historyStack=[],this._historyIndex=-1,this.dispatchEvent(new CustomEvent("editor-closed",{bubbles:!0,composed:!0}))}_saveSchedule(){if(!this._editingWeekday||!this._editingBlocks||void 0===this._editingBaseTemperature)return;const e=Tt(yt(this._editingBlocks,this._editingBaseTemperature),this.minTemp,this.maxTemp);if(e){const t=this._translateValidationMessage(e);return void this.dispatchEvent(new CustomEvent("validation-failed",{detail:{error:t},bubbles:!0,composed:!0}))}this.dispatchEvent(new CustomEvent("save-schedule",{detail:{weekday:this._editingWeekday,blocks:this._editingBlocks,baseTemperature:this._editingBaseTemperature},bubbles:!0,composed:!0}))}_saveAndClose(){this._saveSchedule()}render(){return this.open&&this._editingWeekday?O`
    ...
    `:O``}_formatEdit(e){return(this.translations?.edit??"Edit {weekday}").replace("{weekday}",this._getWeekdayLabel(e,"long"))}_renderEditor(){if(!this._editingWeekday||!this._editingBlocks)return O``;const e=void 0!==this._editingBaseTemperature?xt(this._editingBlocks,this._editingBaseTemperature):this._editingBlocks;return O`
      <div class="editor">
        ...
        ${this._validationWarnings.length>0?O`
              <ha-alert alert-type="warning" .title=${this.translations?.warningsTitle??""}>
                <ul class="warnings-list">
                  ${this._validationWarnings.map(e=>O`<li class="warning-item">
        ...
        <div class="base-temperature-section">
          ...
          <div class="base-temperature-input">
            ...
            <div
              ...
              style="background-color: ${gt(this._editingBaseTemperature||20)}"
            ></div>
          </div>
        </div>
        ...
        <div class="editor-content">
          ...
          ${e.map((t,i)=>{const s=this._editingBlocks.findIndex(e=>e.startMinutes===t.startMinutes&&e.endMinutes===t.endMinutes),a=!(-1!==s);return void 0!==this._editingSlotIndex&&this._editingSlotIndex===s&&void 0!==this._editingSlotData&&this._editingSlotData?O`
                <div class="time-block-editor editing">
                  ...
                  <div
                    class="color-indicator"
                    style="background-color: ${gt(this._editingSlotData.temperature)}"
                  ></div>
                </div>
              `:O`
              <div class="time-block-editor ${a?"base-temp-slot":""}">
                ...
                <div
                  class="color-indicator"
                  style="background-color: ${gt(t.temperature)}"
                ></div>
              </div>
            `})}
          ${this._editingBlocks.length<12&&void 0===this._editingSlotIndex?O`
    ...
    `}static{this.styles=zt}};Nt([pe({type:Boolean})],Rt.prototype,"open",void 0),Nt([pe({type:String})],Rt.prototype,"weekday",void 0),Nt([pe({attribute:!1})],Rt.prototype,"scheduleData",void 0),Nt([pe({type:Number})],Rt.prototype,"minTemp",void 0),Nt([pe({type:Number})],Rt.prototype,"maxTemp",void 0),Nt([pe({type:Number})],Rt.prototype,"tempStep",void 0),Nt([pe({type:String})],Rt.prototype,"temperatureUnit",void 0),Nt([pe({type:String})],Rt.prototype,"hourFormat",void 0),Nt([pe({attribute:!1})],Rt.prototype,"translations",void 0),Nt([_e()],Rt.prototype,"_editingWeekday",void 0),Nt([_e()],Rt.prototype,"_editingBlocks",void 0),Nt([_e()],Rt.prototype,"_editingBaseTemperature",void 0),Nt([_e()],Rt.prototype,"_validationWarnings",void 0),Nt([_e()],Rt.prototype,"_editingSlotIndex",void 0),Nt([_e()],Rt.prototype,"_editingSlotData",void 0),Rt=Nt([Je("hmip-schedule-editor")],Rt);const Bt=r`
  :host {
    display: block;
  }
...
`;var Vt=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Ut=class extends oe{constructor(){super(...arguments),this.editable=!0}static{this.styles=Bt}_handleAdd(){this.dispatchEvent(new CustomEvent("add-event",{bubbles:!0,composed:!0}))}_handleEdit(e){this.dispatchEvent(new CustomEvent("edit-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}_handleDelete(e){this.dispatchEvent(new CustomEvent("delete-event",{bubbles:!0,composed:!0,detail:{entry:e}}))}render(){if(!this.scheduleData)return O`<div class="no-data">${this.translations.loading}</div>`;const e=function(e){const t=[];for(const[i,s]of Object.entries(e))t.push({...s,groupNo:i,isActive:kt(s)});return t.sort((e,t)=>e.time.localeCompare(t.time)),t}(this.scheduleData);return 0===e.length?O`
        <div class="no-data">
          <p>${this.translations.noScheduleEvents}</p>
          ${this.editable?O`<ha-button @click=${this._handleAdd}> ${this.translations.addEvent} </ha-button>`:""}
        </div>
      `:O`
      <div class="schedule-list">
        ${this.editable?O`<div class="toolbar">
        ...
        <div class="events-table">
          <div class="events-header ${this.editable?"":"no-actions"}">
            ...
            ${this.editable?O`<div class="col-actions"></div>`:""}
          </div>
          ${dt(e,e=>e.groupNo,e=>this._renderEvent(e))}
        </div>
      </div>
    `}_renderEvent(e){const t=function(e,t){const i=t?pt[t]:void 0;return"binary"===i?.levelType?0===e?"Off":"On":`${Math.round(100*e)}%`}(e.level,this.domain),i=function(e){if(!e)return"-";const t=Ct(e);return t?`${t.value}${{ms:"ms",s:"s",min:"min",h:"h"}[t.unit]}`:e}(e.duration);return O`
      <div
      ...
      >
        ...
        <div class="col-weekdays">
          <div class="weekday-badges">
            ${ct.map(t=>{const i=e.weekdays.includes(t);return O`<span class="weekday-badge ${i?"active":"inactive"}"
    ...
    `}};Vt([pe({attribute:!1})],Ut.prototype,"scheduleData",void 0),Vt([pe({attribute:!1})],Ut.prototype,"domain",void 0),Vt([pe({type:Boolean})],Ut.prototype,"editable",void 0),Vt([pe({attribute:!1})],Ut.prototype,"translations",void 0),Ut=Vt([Je("hmip-device-schedule-list")],Ut);const Ft=r`
  :host {
    display: block;
  }
...
`;var Ht=function(e,t,i,s){var a,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var o=e.length-1;o>=0;o--)(a=e[o])&&(r=(n<3?a(r):n>3?a(t,i,r):a(t,i))||r);return n>3&&r&&Object.defineProperty(t,i,r),r};let Ot=class extends oe{constructor(){super(...arguments),this.open=!1,this.isNewEvent=!1,this._validationErrors=[]}static{this.styles=Ft}willUpdate(e){(e.has("open")||e.has("entry"))&&(this.open&&this.entry?(this._editingEntry={...this.entry},this._validationErrors=[]):this.open||(this._editingEntry=void 0,this._validationErrors=[]))}_updateEditingEntry(e){this._editingEntry&&(this._editingEntry={...this._editingEntry,...e},this._validationErrors=[],this.requestUpdate())}_handleClose(){this.dispatchEvent(new CustomEvent("editor-closed",{bubbles:!0,composed:!0}))}_handleSave(){if(!this._editingEntry||void 0===this.groupNo)return;const e=function(e,t){const i=[];(function(e){try{return function(e){const t=e.split(":");if(2!==t.length)throw new Error(`Invalid time format: ${e}`);const i=parseInt(t[0],10),s=parseInt(t[1],10);if(isNaN(i)||isNaN(s)||i<0||i>23||s<0||s>59)throw new Error(`Invalid time values: ${e}`)}(e),!0}catch{return!1}})(e.time)||i.push({field:"time",message:"Time must be in HH:MM format (00:00-23:59)"}),e.weekdays&&0!==e.weekdays.length||i.push({field:"weekdays",message:"At least one weekday must be selected"});const s=t?pt[t]:void 0;return"binary"===s?.levelType?0!==e.level&&1!==e.level&&i.push({field:"level",message:"Level must be 0 or 1 for switch"}):(e.level<0||e.level>1)&&i.push({field:"level",message:"Level must be between 0.0 and 1.0"}),"cover"===t&&null!==e.level_2&&(e.level_2<0||e.level_2>1)&&i.push({field:"level_2",message:"Slat position must be between 0.0 and 1.0"}),wt(e.condition)&&(e.astro_offset_minutes<-720||e.astro_offset_minutes>720)&&i.push({field:"astro_offset_minutes",message:"Astro offset must be between -720 and 720 minutes"}),null===e.duration||At(e.duration)||i.push({field:"duration",message:"Invalid duration format"}),null===e.ramp_time||At(e.ramp_time)||i.push({field:"ramp_time",message:"Invalid ramp time format"}),i}(this._editingEntry,this.domain);e.length>0?this._validationErrors=e.map(e=>`${e.field}: ${e.message}`):this.dispatchEvent(new CustomEvent("save-event",{bubbles:!0,composed:!0,detail:{entry:{...this._editingEntry},groupNo:this.groupNo}}))}render(){return this.open&&this._editingEntry?O`
      <ha-dialog
        open
    ...
    `:O``}_renderValidationErrors(){return 0===this._validationErrors.length?O``:O`
      <ha-alert alert-type="error">
        <ul class="validation-list">
          ${this._validationErrors.map(e=>O`<li>${e}</li>`)}
        </ul>
      </ha-alert>
    `}_renderTimeFields(){return this._editingEntry?O`
    ...
    `:O``}_renderConditionFields(){if(!this._editingEntry)return O``;const e=wt(this._editingEntry.condition);return O`
      <div class="form-group">
        <label>${this.translations.condition}</label>
        <ha-select
          .value=${this._editingEntry.condition}
          .options=${ht.map(e=>({value:e,label:this.translations.conditionLabels[e]||e}))}
      ...
      ${e?O`
          ...
          `:""}
    `}_renderWeekdayFields(){return this._editingEntry?O`
      <div class="form-group">
        <label>${this.translations.weekdaysLabel}</label>
        <div class="weekday-checkboxes">
          ${ct.map(e=>{const t=this._editingEntry.weekdays.includes(e);return O`
    ...
    `:O``}_renderLevelFields(){if(!this._editingEntry)return O``;const e=this.domain?pt[this.domain]:void 0;return O`
      <div class="form-group">
        <label>${this.translations.stateLabel}</label>
        ${"binary"===e?.levelType?O`
              <ha-select
      ...
      ${e?.hasLevel2?O`
          ...
          `:""}
    `}_renderDurationFields(){if(!this._editingEntry)return O``;const e=this.domain?pt[this.domain]:void 0;if(e&&!e.hasDuration)return O``;const t=this._editingEntry.duration?Ct(this._editingEntry.duration):null,i=t?.value??0,s=t?.unit??"s";return O`
      <div class="form-group">
        ...
        <div class="duration-row">
          <input
            ...
            min="0"
            .value=${String(i)}
            @input=${e=>{const t=parseFloat(e.target.value);!isNaN(t)&&t>0?this._updateEditingEntry({duration:Et(t,s)}):this._updateEditingEntry({duration:null})}}
          />
          <ha-select
            .value=${s}
            .options=${_t.map(e=>({value:e,label:e}))}
            @selected=${e=>{e.stopPropagation(),i>0&&this._updateEditingEntry({duration:Et(i,e.detail.value)})}}
            @closed=${e=>e.stopPropagation()}
          ></ha-select>
        </div>
      </div>
    `}_renderRampTimeFields(){if(!this._editingEntry)return O``;const e=this.domain?pt[this.domain]:void 0;if(e&&!e.hasRampTime)return O``;const t=this._editingEntry.ramp_time?Ct(this._editingEntry.ramp_time):null,i=t?.value??0,s=t?.unit??"s";return O`
      <div class="form-group">
        ...
        <div class="duration-row">
          <input
            ...
            min="0"
            .value=${String(i)}
            @input=${e=>{const t=parseFloat(e.target.value);!isNaN(t)&&t>0?this._updateEditingEntry({ramp_time:Et(t,s)}):this._updateEditingEntry({ramp_time:null})}}
          />
          <ha-select
            .value=${s}
            .options=${_t.map(e=>({value:e,label:e}))}
            @selected=${e=>{e.stopPropagation(),i>0&&this._updateEditingEntry({ramp_time:Et(i,e.detail.value)})}}
            @closed=${e=>e.stopPropagation()}
          ></ha-select>
        </div>
      </div>
    `}_renderChannelFields(){return this._editingEntry&&this.availableTargetChannels&&Object.keys(this.availableTargetChannels).length>0?O`
        <div class="form-group">
          <label>${this.translations.channels}</label>
          <div class="channel-checkboxes">
            ${Object.entries(this.availableTargetChannels).map(([e,t])=>{const i=this._editingEntry.target_channels.includes(e);return O`
                <label class="checkbox-label">
                  <ha-checkbox
                    .checked=${i}
      ...
      `:O``}};Ht([pe({type:Boolean})],Ot.prototype,"open",void 0),Ht([pe({attribute:!1})],Ot.prototype,"entry",void 0),Ht([pe()],Ot.prototype,"groupNo",void 0),Ht([pe({type:Boolean})],Ot.prototype,"isNewEvent",void 0),Ht([pe({attribute:!1})],Ot.prototype,"domain",void 0),Ht([pe({attribute:!1})],Ot.prototype,"availableTargetChannels",void 0),Ht([pe({attribute:!1})],Ot.prototype,"translations",void 0),Ht([_e()],Ot.prototype,"_editingEntry",void 0),Ht([_e()],Ot.prototype,"_validationErrors",void 0),Ot=Ht([Je("hmip-device-schedule-editor")],Ot);let Wt=class extends oe{constructor(){super(...arguments),this.entryId="",this.deviceAddress="",this.deviceName="",this._devices=[],this._selectedDevice=null,this._climateData=null,this._deviceData=null,this._selectedProfile="",this._loading=!0,this._saving=!1,this._error="",this._deviceShowEditor=!1,this._deviceIsNewEvent=!1}updated(e){(e.has("entryId")||e.has("deviceAddress"))&&this.entryId&&this._fetchDevices()}async _fetchDevices(){this._loading=!0,this._error="";try{let e;this._devices=await we(this.hass,this.entryId),this.deviceAddress&&(e=this._devices.find(e=>e.address===this.deviceAddress)),!e&&this._devices.length>0&&(e=this._devices[0]),e&&(this._selectedDevice=e,await this._loadSchedule(e))}catch(e){this._error=String(e)}finally{this._loading=!1}}async _loadSchedule(e){this._loading=!0,this._error="",this._climateData=null,this._deviceData=null;try{if("climate"===e.schedule_type){let t=this._selectedProfile||void 0;if(!t){const i=await Se(this.hass,this.entryId,e.address);t=i.active_profile,this._selectedProfile=t;const s=Object.keys(i.schedule_data).some(e=>"MONDAY"===e||"TUESDAY"===e||"WEDNESDAY"===e||"THURSDAY"===e||"FRIDAY"===e||"SATURDAY"===e||"SUNDAY"===e);s&&(this._climateData=i)}if(!this._climateData){const i=await Se(this.hass,this.entryId,e.address,t);this._climateData=i,!this._selectedProfile&&i.active_profile&&(this._selectedProfile=i.active_profile)}}else this._deviceData=await async function(e,t,i){return e.callWS({type:"homematicip_local/config/get_device_schedule",entry_id:t,device_address:i})}(this.hass,this.entryId,e.address)}catch{this._error=this._l("device_schedule.load_failed")}finally{this._loading=!1}}_l(e,t){return Pe(this.hass,e,t)}_handleBack(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}async _handleDeviceSelect(e){e.stopPropagation();const t=e.detail.value;if(!t||t===this._selectedDevice?.address)return;const i=this._devices.find(e=>e.address===t);i&&(this._selectedDevice=i,this._selectedProfile="",this._editingWeekday=void 0,this._copiedSchedule=void 0,this._deviceShowEditor=!1,this._deviceEditingEntry=void 0,this._deviceEditingGroupNo=void 0,this._deviceIsNewEvent=!1,await this._loadSchedule(i))}async _handleProfileChange(e){e.stopPropagation();const t=e.detail.value;if(t&&t!==this._selectedProfile&&(this._selectedProfile=t,this._selectedDevice)){try{await async function(e,t,i,s){return e.callWS({type:"homematicip_local/config/set_climate_active_profile",entry_id:t,device_address:i,profile:s})}(this.hass,this.entryId,this._selectedDevice.address,t)}catch{return void Re(this,{message:this._l("device_schedule.save_failed")})}await this._loadSchedule(this._selectedDevice)}}_onWeekdayClick(e){this._editingWeekday=e.detail.weekday}_onCopySchedule(e){const t=e.detail.weekday;if(!this._climateData)return;const i=this._climateData.schedule_data[t];if(!i)return;const{blocks:s,baseTemperature:a}=ft(i);this._copiedSchedule={weekday:t,blocks:JSON.parse(JSON.stringify(s)),baseTemperature:a}}async _onPasteSchedule(e){const t=e.detail.weekday;if(!this._selectedDevice||!this._copiedSchedule||!this._climateData)return;const i=this._copiedSchedule.baseTemperature??function(e){if(0===e.length)return 20;const t=new Map;for(const i of e){const e=i.endMinutes-i.startMinutes,s=t.get(i.temperature)||0;t.set(i.temperature,s+e)}let i=0,s=20;for(const[e,a]of t.entries())a>i&&(i=a,s=e);return s}(this._copiedSchedule.blocks),s=yt(this._copiedSchedule.blocks,i);if(Tt(s,this._climateData.min_temp??5,this._climateData.max_temp??30.5))Re(this,{message:this._l("device_schedule.invalid_schedule")});else{this._saving=!0;try{const{base_temperature:e,periods:i}=s;await Ce(this.hass,this.entryId,this._selectedDevice.address,this._selectedProfile,t,e,i.map(e=>({...e}))),Re(this,{message:this._l("device_schedule.save_success")}),await this._loadSchedule(this._selectedDevice)}catch{Re(this,{message:this._l("device_schedule.save_failed")})}finally{this._saving=!1}}}async _onSaveSchedule(e){if(!this._selectedDevice||!this._climateData)return;const{weekday:t,blocks:i,baseTemperature:s}=e.detail,a=yt(i,s);if(Tt(a,this._climateData.min_temp??5,this._climateData.max_temp??30.5))Re(this,{message:this._l("device_schedule.invalid_schedule")});else{this._saving=!0;try{const{base_temperature:e,periods:i}=a;await Ce(this.hass,this.entryId,this._selectedDevice.address,this._selectedProfile,t,e,i.map(e=>({...e}))),Re(this,{message:this._l("device_schedule.save_success")}),this._editingWeekday=void 0,await this._loadSchedule(this._selectedDevice)}catch{Re(this,{message:this._l("device_schedule.save_failed")})}finally{this._saving=!1}}}_onValidationFailed(e){Re(this,{message:this._l("device_schedule.invalid_schedule",{error:e.detail.error})})}_onEditorClosed(){this._editingWeekday=void 0}async _handleReload(){if(this._selectedDevice)try{await async function(e,t,i){return e.callWS({type:"homematicip_local/config/reload_device_config",entry_id:t,device_address:i})}(this.hass,this.entryId,this._selectedDevice.address),Re(this,{message:this._l("device_schedule.reload_success")}),await this._loadSchedule(this._selectedDevice)}catch{Re(this,{message:this._l("device_schedule.reload_failed")})}}async _handleExport(){const e=this._climateData?.schedule_data??this._deviceData?.schedule_data;if(!e)return;const t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s;const n=this._selectedDevice?.address.replace(/:/g,"_")??"schedule";a.download=`${n}_schedule.json`,a.click(),URL.revokeObjectURL(s)}async _handleImport(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=async()=>{const t=e.files?.[0];if(t&&this._selectedDevice)try{const e=await t.text(),i=JSON.parse(e);if(!await ze(0,{title:this._l("device_schedule.import_confirm_title"),text:this._l("device_schedule.import_confirm_text"),confirmText:this._l("device_schedule.import"),dismissText:this._l("common.cancel")}))return;"climate"===this._selectedDevice.schedule_type?(this._climateData={...this._climateData,schedule_data:i},Re(this,{message:this._l("device_schedule.import_success")})):(await Ee(this.hass,this.entryId,this._selectedDevice.address,i),Re(this,{message:this._l("device_schedule.import_success")}),await this._loadSchedule(this._selectedDevice))}catch{Re(this,{message:this._l("device_schedule.import_failed")})}},e.click()}_buildGridTranslations(){return{weekdayShortLabels:{MONDAY:this._l("device_schedule.weekdays").split(",")[0],TUESDAY:this._l("device_schedule.weekdays").split(",")[1],WEDNESDAY:this._l("device_schedule.weekdays").split(",")[2],THURSDAY:this._l("device_schedule.weekdays").split(",")[3],FRIDAY:this._l("device_schedule.weekdays").split(",")[4],SATURDAY:this._l("device_schedule.weekdays").split(",")[5],SUNDAY:this._l("device_schedule.weekdays").split(",")[6]},clickToEdit:this._l("device_schedule.click_to_edit"),copySchedule:this._l("device_schedule.copy_schedule"),pasteSchedule:this._l("device_schedule.paste_schedule")}}_buildEditorTranslations(){const e=this._l("device_schedule.weekdays").split(",");return{weekdayShortLabels:{MONDAY:e[0],TUESDAY:e[1],WEDNESDAY:e[2],THURSDAY:e[3],FRIDAY:e[4],SATURDAY:e[5],SUNDAY:e[6]},weekdayLongLabels:{MONDAY:this._l("device_schedule.weekday_monday"),TUESDAY:this._l("device_schedule.weekday_tuesday"),WEDNESDAY:this._l("device_schedule.weekday_wednesday"),THURSDAY:this._l("device_schedule.weekday_thursday"),FRIDAY:this._l("device_schedule.weekday_friday"),SATURDAY:this._l("device_schedule.weekday_saturday"),SUNDAY:this._l("device_schedule.weekday_sunday")},edit:this._l("device_schedule.edit"),cancel:this._l("common.cancel"),save:this._l("device_schedule.save"),addTimeBlock:this._l("device_schedule.add_time_block"),from:this._l("device_schedule.from"),to:this._l("device_schedule.to"),baseTemperature:this._l("device_schedule.base_temperature"),baseTemperatureDescription:this._l("device_schedule.base_temperature_description"),temperaturePeriods:this._l("device_schedule.temperature_periods"),editSlot:this._l("device_schedule.edit_slot"),saveSlot:this._l("device_schedule.save_slot"),cancelSlotEdit:this._l("device_schedule.cancel_slot_edit"),undoShortcut:this._l("device_schedule.undo_shortcut"),redoShortcut:this._l("device_schedule.redo_shortcut"),warningsTitle:this._l("device_schedule.warnings_title"),validationMessages:{blockEndBeforeStart:this._l("device_schedule.validation_block_end_before_start"),blockZeroDuration:this._l("device_schedule.validation_block_zero_duration"),invalidStartTime:this._l("device_schedule.validation_invalid_start_time"),invalidEndTime:this._l("device_schedule.validation_invalid_end_time"),temperatureOutOfRange:this._l("device_schedule.validation_temp_out_of_range"),invalidSlotCount:this._l("device_schedule.validation_invalid_slot_count"),invalidSlotKey:this._l("device_schedule.validation_invalid_slot_key"),missingSlot:this._l("device_schedule.validation_missing_slot"),slotMissingValues:this._l("device_schedule.validation_slot_missing_values"),slotTimeBackwards:this._l("device_schedule.validation_slot_time_backwards"),slotTimeExceedsDay:this._l("device_schedule.validation_slot_time_exceeds_day"),lastSlotMustEnd:this._l("device_schedule.validation_last_slot_must_end"),scheduleMustBeObject:this._l("device_schedule.validation_schedule_must_be_object"),missingWeekday:this._l("device_schedule.validation_missing_weekday"),invalidWeekdayData:this._l("device_schedule.validation_invalid_weekday_data"),weekdayValidationError:this._l("device_schedule.validation_weekday_error")}}}render(){return this._loading&&0===this._devices.length?O`<div class="loading">${this._l("common.loading")}</div>`:this._error&&0===this._devices.length?O`<div class="error">${this._error}</div>`:O`
      <ha-icon-button
        class="back-button"
        .path=${"M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"}
        @click=${this._handleBack}
      ...
      ${0===this._devices.length?O`<div class="empty-state">${this._l("device_schedule.no_devices")}</div>`:j}
      ${this._selectedDevice&&this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:j}
      ${this._error&&this._selectedDevice?O`<div class="error">${this._error}</div>`:j}
    ...
    `}_renderClimateSchedule(){const e=this._climateData,t=e.schedule_data;return O`
      <div class="schedule-content">
        <div class="toolbar">
          <div class="profile-selector">
            <ha-select
    ...
    `]}};async function jt(e,t){return e.callWS({type:"homematicip_local/integration/get_system_health",entry_id:t})}async function Kt(e,t){return(await e.callWS({type:"homematicip_local/integration/get_command_throttle_stats",entry_id:t})).throttle_stats}async function Yt(e,t,i=50,s){return e.callWS({type:"homematicip_local/integration/get_incidents",entry_id:t,limit:i,...s})}async function Zt(e,t){return e.callWS({type:"homematicip_local/integration/get_device_statistics",entry_id:t})}async function Gt(e,t){return e.callWS({type:"homematicip_local/ccu/get_system_information",entry_id:t})}async function qt(e,t){return e.callWS({type:"homematicip_local/ccu/get_install_mode_status",entry_id:t})}async function Qt(e,t){return(await e.callWS({type:"homematicip_local/ccu/get_signal_quality",entry_id:t})).devices}async function Jt(e,t){return e.callWS({type:"homematicip_local/ccu/get_firmware_overview",entry_id:t})}var Xt;e([pe({attribute:!1})],Wt.prototype,"hass",void 0),e([pe()],Wt.prototype,"entryId",void 0),e([pe()],Wt.prototype,"deviceAddress",void 0),e([pe()],Wt.prototype,"deviceName",void 0),e([_e()],Wt.prototype,"_devices",void 0),e([_e()],Wt.prototype,"_selectedDevice",void 0),e([_e()],Wt.prototype,"_climateData",void 0),e([_e()],Wt.prototype,"_deviceData",void 0),e([_e()],Wt.prototype,"_selectedProfile",void 0),e([_e()],Wt.prototype,"_editingWeekday",void 0),e([_e()],Wt.prototype,"_copiedSchedule",void 0),e([_e()],Wt.prototype,"_loading",void 0),e([_e()],Wt.prototype,"_saving",void 0),e([_e()],Wt.prototype,"_error",void 0),e([_e()],Wt.prototype,"_deviceEditingEntry",void 0),e([_e()],Wt.prototype,"_deviceEditingGroupNo",void 0),e([_e()],Wt.prototype,"_deviceShowEditor",void 0),e([_e()],Wt.prototype,"_deviceIsNewEvent",void 0),Wt=e([ue("hm-device-schedule")],Wt);let ei=class extends oe{constructor(){super(...arguments),this.entryId="",this._health=null,this._throttle=null,this._incidents=null,this._deviceStats=null,this._loading=!0,this._error=""}static{Xt=this}static{this._POLL_INTERVAL_FAST=5e3}static{this._POLL_INTERVAL_SLOW=3e4}static{this._STABLE_STATES=["RUNNING","running"]}updated(e){e.has("entryId")&&this.entryId&&(this._stopPolling(),this._fetchAll())}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}_isStableState(){return null!==this._health&&Xt._STABLE_STATES.includes(this._health.central_state)}_scheduleNextPoll(){this._stopPolling();const e=this._isStableState()?Xt._POLL_INTERVAL_SLOW:Xt._POLL_INTERVAL_FAST;this._pollTimer=setTimeout(()=>this._fetchAll(),e)}_stopPolling(){void 0!==this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=void 0)}async _fetchAll(){if(this.entryId){null===this._health&&(this._loading=!0),this._error="";try{const[e,t,i,s]=await Promise.all([jt(this.hass,this.entryId),Kt(this.hass,this.entryId),Yt(this.hass,this.entryId),Zt(this.hass,this.entryId)]);this._health=e,this._throttle=t,this._incidents=i,this._deviceStats=s}catch(e){this._error=String(e)}finally{this._loading=!1,this._scheduleNextPoll()}}}_l(e,t){return Pe(this.hass,e,t)}async _handleClearIncidents(){if(await ze(0,{title:this._l("integration.clear_incidents_title"),text:this._l("integration.clear_incidents_text"),confirmText:this._l("integration.clear"),dismissText:this._l("common.cancel"),destructive:!0}))try{await async function(e,t){return e.callWS({type:"homematicip_local/integration/clear_incidents",entry_id:t})}(this.hass,this.entryId),Re(this,{message:this._l("integration.incidents_cleared")}),this._incidents=await Yt(this.hass,this.entryId)}catch{Re(this,{message:this._l("integration.action_failed")})}}async _handleClearCache(){if(await ze(0,{title:this._l("integration.clear_cache_title"),text:this._l("integration.clear_cache_text"),confirmText:this._l("integration.clear"),dismissText:this._l("common.cancel"),destructive:!0}))try{await async function(e,t){return e.callWS({type:"homematicip_local/integration/clear_cache",entry_id:t})}(this.hass,this.entryId),Re(this,{message:this._l("integration.cache_cleared")})}catch{Re(this,{message:this._l("integration.action_failed")})}}render(){return this.entryId?this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:this._error?O`<div class="error">${this._error}</div>`:O`
    ...
    `:O`<div class="empty-state">${this._l("device_list.no_entry_selected")}</div>`}_renderHealthCard(){return this._health?O`
      <ha-card>
    ...
    `:j}_renderDeviceStatsCard(){if(!this._deviceStats)return j;const e=this._deviceStats;return O`
      <ha-card>
        ...
        <div class="card-content">
          ...
          ${Object.keys(e.by_interface).length>1?O`
                <div class="interface-breakdown">
                  ${Object.entries(e.by_interface).map(([e,t])=>O`
    ...
    `}_renderThrottleCard(){return this._throttle&&0!==Object.keys(this._throttle).length?O`
      <ha-card>
        <div class="card-header">${this._l("integration.command_throttle")}</div>
        <div class="card-content">
          ${Object.entries(this._throttle).map(([e,t])=>O`
    ...
    `:j}_renderIncidentsCard(){if(!this._incidents)return j;const{incidents:e,summary:t}=this._incidents;return O`
      <ha-card>
        ...
        <div class="card-content">
          ${0===e.length?O`<div class="empty-state">${this._l("integration.no_incidents")}</div>`:O`
    ...
    `}_formatScore(e){return`${Math.round(e<=1?100*e:e)}%`}_formatTimestamp(e){if(!e)return"";try{return new Date(e).toLocaleString(this.hass.config.language||"en")}catch{return e}}static{this.styles=[ve,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `]}};var ti;e([pe({attribute:!1})],ei.prototype,"hass",void 0),e([pe()],ei.prototype,"entryId",void 0),e([_e()],ei.prototype,"_health",void 0),e([_e()],ei.prototype,"_throttle",void 0),e([_e()],ei.prototype,"_incidents",void 0),e([_e()],ei.prototype,"_deviceStats",void 0),e([_e()],ei.prototype,"_loading",void 0),e([_e()],ei.prototype,"_error",void 0),ei=Xt=e([ue("hm-integration-dashboard")],ei);let ii=class extends oe{constructor(){super(...arguments),this.entryId="",this._sysInfo=null,this._installMode=null,this._signalDevices=null,this._firmware=null,this._loading=!0,this._error="",this._backupRunning=!1,this._refreshingFirmware=!1,this._signalSortColumn="name",this._signalSortAsc=!0,this._signalFilter="",this._signalInterfaceFilter="",this._signalReachableFilter="",this._signalBatteryFilter="",this._firmwareSortColumn="name",this._firmwareSortAsc=!0,this._firmwareFilter="",this._firmwareStateFilter=""}static{ti=this}static{this._POLL_INTERVAL=3e4}disconnectedCallback(){super.disconnectedCallback(),this._stopInstallModePolling(),this._stopPolling()}updated(e){e.has("entryId")&&this.entryId&&(this._stopPolling(),this._fetchAll())}_scheduleNextPoll(){this._stopPolling(),this._pollTimer=setTimeout(()=>this._fetchAll(),ti._POLL_INTERVAL)}_stopPolling(){void 0!==this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=void 0)}async _fetchAll(){if(this.entryId){null===this._sysInfo&&(this._loading=!0),this._error="";try{const[e,t,i,s]=await Promise.all([Gt(this.hass,this.entryId),qt(this.hass,this.entryId),Qt(this.hass,this.entryId),Jt(this.hass,this.entryId)]);this._sysInfo=e,this._installMode=t,this._signalDevices=i,this._firmware=s,(t.hmip.active||t.bidcos.active)&&this._startInstallModePolling()}catch(e){this._error=String(e)}finally{this._loading=!1,this._scheduleNextPoll()}}}_l(e,t){return Pe(this.hass,e,t)}async _handleCreateBackup(){if(await ze(0,{title:this._l("ccu.create_backup_title"),text:this._l("ccu.create_backup_text"),confirmText:this._l("ccu.create_backup"),dismissText:this._l("common.cancel")})){this._backupRunning=!0;try{const e=await async function(e,t){return e.callWS({type:"homematicip_local/ccu/create_backup",entry_id:t})}(this.hass,this.entryId);if(e.success){const t=(e.size/1024/1024).toFixed(1);Re(this,{message:this._l("ccu.backup_success",{filename:e.filename,size:t})})}}catch{Re(this,{message:this._l("ccu.backup_failed")})}finally{this._backupRunning=!1}}}async _handleTriggerInstallMode(e){const t="hmip"===e?"HmIP-RF":"BidCos-RF";if(await ze(0,{title:this._l("ccu.install_mode_title"),text:this._l("ccu.install_mode_text",{interface:t}),confirmText:this._l("ccu.activate"),dismissText:this._l("common.cancel")}))try{await async function(e,t,i){return e.callWS({type:"homematicip_local/ccu/trigger_install_mode",entry_id:t,interface:i})}(this.hass,this.entryId,e),Re(this,{message:this._l("ccu.install_mode_activated",{interface:t})}),this._installMode=await qt(this.hass,this.entryId),this._startInstallModePolling()}catch{Re(this,{message:this._l("ccu.action_failed")})}}_startInstallModePolling(){this._stopInstallModePolling(),this._installModeTimer=setInterval(async()=>{try{this._installMode=await qt(this.hass,this.entryId),this._installMode.hmip.active||this._installMode.bidcos.active||this._stopInstallModePolling()}catch{this._stopInstallModePolling()}},1e3)}_stopInstallModePolling(){void 0!==this._installModeTimer&&(clearInterval(this._installModeTimer),this._installModeTimer=void 0)}async _handleRefreshFirmware(){this._refreshingFirmware=!0;try{await async function(e,t){return e.callWS({type:"homematicip_local/ccu/refresh_firmware_data",entry_id:t})}(this.hass,this.entryId),Re(this,{message:this._l("ccu.firmware_refreshed")}),this._firmware=await Jt(this.hass,this.entryId)}catch{Re(this,{message:this._l("ccu.action_failed")})}finally{this._refreshingFirmware=!1}}render(){return this.entryId?this._loading?O`<div class="loading">${this._l("common.loading")}</div>`:this._error?O`<div class="error">${this._error}</div>`:O`
    ...
    `:O`<div class="empty-state">${this._l("device_list.no_entry_selected")}</div>`}_renderSystemInfoCard(){if(!this._sysInfo)return j;const e=this._sysInfo;return O`
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="status-badges">
            ${e.has_system_update?O`<span class="status-badge update-available"
                  >${this._l("ccu.update_available")}</span
                >`:j}
          </div>
        </div>
      </ha-card>
    `}_renderInstallModeCard(){if(!this._installMode)return j;const{hmip:e,bidcos:t}=this._installMode;return e.available||t.available?O`
      <ha-card>
    ...
    `:j}_renderInstallModeItem(e,t,i){return O`
      <div class="install-mode-item">
        ...
        ${i.active&&null!==i.remaining_seconds?O`<span class="install-mode-remaining"
            ...
            <tbody>
              ${i.map(e=>O`
                  <tr class="${e.is_reachable?"":"unreachable-row"}">
                    ...
                    <td>${e.rssi_device??"—"}</td>
                    <td>
                      ${null===e.low_battery?"—":e.low_battery?O`<span class="warn-text">${this._l("ccu.low")}</span>`:this._l("ccu.ok")}
                    </td>
                  </tr>
                `)}
            </tbody>
                ...
                <div class="filter-bar">
                  ...
                  <div class="filter-selects">
                    <ha-select
                      ...
                      .options=${[{value:"",label:this._l("ccu.filter_all")},...n.map(e=>({value:e,label:e}))]}
                      @selected=${e=>{e.stopPropagation(),this._firmwareStateFilter=e.detail.value??""}}
                      @closed=${e=>e.stopPropagation()}
                    ></ha-select>
                  </div>
                </div>
                ${a?O`<div class="filter-count">
    ...
    `}render(){if("integration-dashboard"===this._view)return O`
        ${this._renderTabs()}
        <hm-integration-dashboard
          .hass=${this.hass}
          .entryId=${this._entryId}
        ></hm-integration-dashboard>
      `;if("ccu-dashboard"===this._view)return O`
        ${this._renderTabs()}
        <hm-ccu-dashboard .hass=${this.hass} .entryId=${this._entryId}></hm-ccu-dashboard>
      `;switch(this._view){case"device-list":return O`
          ${this._renderTabs()}
          <hm-device-list
            .hass=${this.hass}
            .entryId=${this._entryId}
  ...
  `}};e([pe({attribute:!1})],si.prototype,"hass",void 0),e([pe({attribute:!1})],si.prototype,"panel",void 0),e([pe({type:Boolean,reflect:!0})],si.prototype,"narrow",void 0),e([_e()],si.prototype,"_tab",void 0),e([_e()],si.prototype,"_view",void 0),e([_e()],si.prototype,"_entryId",void 0),e([_e()],si.prototype,"_entries",void 0),e([_e()],si.prototype,"_selectedDevice",void 0),e([_e()],si.prototype,"_selectedInterfaceId",void 0),e([_e()],si.prototype,"_selectedChannel",void 0),e([_e()],si.prototype,"_selectedChannelType",void 0),e([_e()],si.prototype,"_selectedParamsetKey",void 0),e([_e()],si.prototype,"_selectedDeviceName",void 0),e([_e()],si.prototype,"_selectedSenderAddress",void 0),e([_e()],si.prototype,"_selectedReceiverAddress",void 0),e([_e()],si.prototype,"_senderDeviceName",void 0),e([_e()],si.prototype,"_senderDeviceModel",void 0),e([_e()],si.prototype,"_senderChannelTypeLabel",void 0),e([_e()],si.prototype,"_receiverDeviceName",void 0),e([_e()],si.prototype,"_receiverDeviceModel",void 0),e([_e()],si.prototype,"_receiverChannelTypeLabel",void 0),si=e([ue("homematic-config")],si);export{si as HomematicConfigPanel};
