...
@pytest.mark.asyncio
async def test_async_setup_services_registers_and_dispatches_all(hass: HomeAssistant, monkeypatch) -> None:
...
@pytest.mark.asyncio
async def test_async_unload_services_removes_all_when_no_entries(hass: HomeAssistant, monkeypatch) -> None:
