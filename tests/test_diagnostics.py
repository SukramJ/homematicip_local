...
def test_get_devices_per_type_stats_returns_sorted_unique_models() -> None:
...
def test_get_data_points_by_platform_stats_aggregates_and_sorts() -> None:
...
@pytest.mark.asyncio
async def test_async_get_config_entry_diagnostics_compiles_payload_and_redacts(hass, mock_loaded_config_entry) -> None:
